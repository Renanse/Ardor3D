 ...
 * states, one of which is currently active. Each of these states may override the current
 * appearance and behavior of the component, making this class an ideal base for components such as
 * "mouse over" buttons, components that can be visibly "disabled", toggleable components, etc.
 */
