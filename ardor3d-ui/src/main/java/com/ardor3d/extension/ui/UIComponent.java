...
public abstract class UIComponent extends Node implements UIKeyHandler {
  ...
  /**
   * A spacing between the component's border and other content outside this component. Used during
   * layout.
   */
  ...
  /**
   * flag to indicate if a component has touched its content area. Used to determine blending
  ...
  /**
   * @return true if this component should be considered "enabled"... a concept that is interpreted by
   *         each individual component type.
   */
  public boolean isEnabled() { return _enabled; }

  /**
   * @param enabled
   *          true if this component should be considered "enabled"... a concept that is interpreted
   *          by each individual component type.
   */
   ...
   */
  public void setVisible(final boolean visible) { _visible = visible; }

  /**
   * Used primarily during rendering to determine how alpha blending should be done.
   *
   * @return true if nothing has been drawn by this component or its ancestors yet that would affect
   *         its content area.
   */
   ...
   */
  public void setVirginContentArea(final boolean virgin) { _virginContentArea = virgin; }

  /**
   * Add a new font style to this component. Will be inherited by children if they do not have the
   * same key.
   *
   * @param styleKey
   *          style key
   ...
   */
  public Map<String, Object> getLocalFontStyles() { return _fontStyles; }
  ...
  /**
   * @param styles
   *          the font styles to use (as needed) for this component. Note that this can be inherited
   *          by child components if this is a container class and styles is null.
   */
   ...
   */
  public UILayoutData getLayoutData() { return _layoutData; }

  /**
   * @param layoutData
   *          the layout data object set on this component. The object would provide specific layout
   *          directions to the layout class of the container this component is placed in.
   */
  public void setLayoutData(final UILayoutData layoutData) { _layoutData = layoutData; }

  /**
   * @return the width of this entire component as a whole, including all margins, borders, padding
   *         and content (in the component's coordinate space.)
   */
  public int getLocalComponentWidth() { return _contentsSize.getWidth() + getTotalLeft() + getTotalRight(); }

  /**
   * @return the height of this entire component as a whole, including all margins, borders, padding
   *         and content (in the component's coordinate space.)
   */
  public int getLocalComponentHeight() { return _contentsSize.getHeight() + getTotalTop() + getTotalBottom(); }
  ...
  /**
   * Sets the width and height of this component by forcing the content area to be of a proper size
   * such that when the padding, margin and border are added, the total component size match those
   * given.
   *
   * @param width
  ...
  protected int getMinimumContentWidth() {
    return Math.max(Math.max(_minimumContentsSize.getWidth(), 0), _layoutMinimumContentsSize.getWidth());
  }

  protected int getMinimumContentHeight() {
    return Math.max(Math.max(_minimumContentsSize.getHeight(), 0), _layoutMinimumContentsSize.getHeight());
  }

  /**
   * @return the width contained in _minimumContentsSize + the margin, border and padding values for
   *         left and right.
   */
  ...
  /**
   * @return the height contained in _minimumContentsSize + the margin, border and padding values for
   *         top and bottom.
   */
  ...
  /**
   * @return the width contained in _maximumContentsSize + the margin, border and padding values for
   *         left and right.
   */
  ...
  /**
   * @return the height contained in _maximumContentsSize + the margin, border and padding values for
   *         top and bottom.
   */
  ...
  /**
   * Sets the height of the content area of this component to that given, as long as we're between min
  ...
  /**
   * Sets the width of the content area of this component to that given, as long as we're between min
  ...
  /**
   * Sets the current component height to that given, as long as it would not violate min and max
   * content height.
   *
   * @param height
   *          the new height
  ...
  /**
   * Sets the current component width to that given, as long as it would not violate min and max
   * content width.
   *
   * @param width
   *          the new width
   ...
   */
  public int getContentWidth() { return _contentsSize.getWidth(); }

  /**
   * @return the height of the content area of this component.
   */
  public int getContentHeight() { return _contentsSize.getHeight(); }
  ...
  public boolean isConsumeKeyEvents() { return _consumeKeyEvents; }

  public void setConsumeKeyEvents(final boolean consume) { _consumeKeyEvents = consume; }

  public boolean isConsumeMouseEvents() { return _consumeMouseEvents; }

  public void setConsumeMouseEvents(final boolean consume) { _consumeMouseEvents = consume; }
  ...
  protected void validateContentSize() {
    ...
    final int height = MathUtils.clamp(_contentsSize.getHeight(), getMinimumContentHeight(), getMaximumContentHeight());
    _contentsSize.set(width, height);
  }

  /**
   * Sets the size of the content area of this component to the current width and height set on
   * _minimumContentsSize (if component is set to allow such resizing.)
   */
  public void compact() {
  ...
  /**
   * @return the sum of the bottom side of this component's margin, border and padding (if they are
   *         set).
   */
  ...
  /**
   * @return the sum of the left side of this component's margin, border and padding (if they are
   *         set).
   */
  ...
  /**
   * @return the sum of the right side of this component's margin, border and padding (if they are
   *         set).
   */
   ...
   */
  public UIBorder getBorder() { return _border; }

  /**
   * @param border
   *          the border we wish this component to use. May be null.
   */
  public void setBorder(final UIBorder border) { _border = border; }

  /**
   * @return the current backdrop set on this component, if any.
   */
  public UIBackdrop getBackdrop() { return _backdrop; }

  /**
   * @param backdrop
   *          the backdrop we wish this component to use. May be null.
   */
  public void setBackdrop(final UIBackdrop backDrop) { _backdrop = backDrop; }
  ...
  /**
   * @param margin
   *          the new margin (a spacing between the component's border and other components) to set on
   *          this component. Copied into the component and is allowed to be null.
   */
  ...
  /**
   * @param padding
   *          the new padding (a spacing between the component's border and its inner content area) to
   *          set on this component. Copied into the component and is allowed to be null.
   */
   ...
   */
  public boolean isAttachedToHUD() { return getParent() instanceof UIHud; }

  /**
   * @return the first instance of UIComponent found in this Component's UIComponent ancestry that is
   *         attached to the hud, or null if none are found. Returns "this" component if it is
   *         directly attached to the hud.
   */
  ...
  /**
   * @return the first instance of UIHud found in this Component's UIComponent ancestry or null if
   *         none are found.
   */
  public UIHud getHud() {
    final Node parent = getParent();
  ...
  /**
   * Override to provide an action to take when this component or its top level component are attached
   * to a UIHud.
   */
  public void attachedToHud() {}

  /**
   * Override to provide an action to take just before this component or its top level component are
   * removed from a UIHud.
   */
   ...
   */
  public int getHudX() { return Math.round(getWorldTranslation().getXf()); }

  /**
   * @return current screen y coordinate of this component's origin (usually its lower left corner.)
   */
  public int getHudY() { return Math.round(getWorldTranslation().getYf()); }
   ...
   */
  public int getLocalX() { return (int) Math.round(getTranslation().getX()); }

  /**
   * @return a local y translation from the parent component's content area.
   */
  public int getLocalY() { return (int) Math.round(getTranslation().getY()); }

  /**
   * Set the x,y translation from the lower left corner of our parent's content area to the origin of
   * this component.
   *
   * @param x
   * @param y
  ...
  /**
   * Set the x translation from the lower left corner of our parent's content area to the origin of
   * this component.
   *
   * @param x
   */
  ...
  /**
   * Set the y translation from the lower left corner of our parent's content area to the origin of
   * this component.
   *
   * @param y
   */
  ...
  /**
   * @return the currently set foreground color on this component. Does not inherit from ancestors or
   *         default, so may return null.
   */
  public ReadOnlyColorRGBA getLocalForegroundColor() { return _foregroundColor; }

  /**
   * @return the foreground color associated with this component. If none has been set, we will ask
   *         our parent component and so on. If no component is found in our ancestry with a
   *         foreground color, we will use {@link #DEFAULT_FOREGROUND_COLOR}
   */
  ...
  /**
   * @return this component's tooltip text. If none has been set, we will ask our parent component and
   *         so on. returns null if no tooltips are found.
   */
   ...
   */
  public void setTooltipText(final String text) { _tooltipText = text; }

  /**
   * @return the amount of time in ms to wait before showing a tooltip for this component.
   */
  public int getTooltipPopTime() { return _tooltipPopTime; }

  /**
   * @param ms
   *          the amount of time in ms to wait before showing a tooltip for this component. This is
   *          only granular to a tenth of a second (or 100ms)
   */
  public void setTooltipPopTime(final int ms) { _tooltipPopTime = ms; }
   ...
   * @return true if the given screen coordinates fall inside the margin area of this component (or in
   *         other words, is at the border level or deeper.)
   */
   ...
   * @param hudY
   *          the y screen coordinate
   * @return this component (or an appropriate child coordinate in the case of a container) if the
   *         given screen coordinates fall inside the margin area of this component.
   */
  ...
  public void draw(final Renderer r) {
    ...
    // If we are drawing this component as part of cached container contents, we need to alter the
    // blending to get a
    ...
    if (UIContainer.isDrawingStandin()) {
      if (getParent() instanceof UIComponent && !((UIComponent) getParent()).hasVirginContentArea()) {
        // we are drawing a sub component onto a surface that already has color, so do a alpha based color
        // blend
        // and use the max alpha value.
        ContextManager.getCurrentContext().enforceState(UIComponent._blendRGBmaxAlphaBlend);
      } else {
        // we are drawing a top level component onto an empty texture surface, so use the source color
        // modulated
   ...
   */
  public static void setDefaultFontFamily(final String family) { UIComponent._defaultFontFamily = family; }

  /**
   * @return the default Font family. Defaults to "Arial".
   */
  public static String getDefaultFontFamily() { return UIComponent._defaultFontFamily; }

  /**
   * @param size
   *          the Font size to use as "default" across all UI components that do not have one set.
   */
  public static void setDefaultFontSize(final int size) { UIComponent._defaultFontSize = size; }

  /**
   * @return the default Font size (height). Defaults to 18.
   */
  public static int getDefaultFontSize() { return UIComponent._defaultFontSize; }
   ...
   */
  public static Map<String, Object> getDefaultFontStyles() { return UIComponent._defaultFontStyles; }

  /**
   * @return a blend state that does alpha blending and writes the max alpha value (source or
   *         destination) back to the color buffer.
   */
  ...
  /**
   * @return the opacity level set on this component in [0,1], where 0 means completely transparent
   *         and 1 is completely opaque. If useTransparency is false, this will always return 1.
   */
   ...
   */
  public float getLocalOpacity() { return _opacity; }
   ...
   */
  public void setOpacity(final float opacity) { _opacity = opacity; }

  /**
   * Tell all ancestors that use standins, if any, that they need to update any cached graphical
   * representation.
   */
  ...
  /**
   * @return true if all components should use their opacity value to blend against other components
   *         (and/or the 3d background scene.)
   */
  public static boolean isUseTransparency() { return UIComponent._useTransparency; }

  /**
   * @param useTransparency
   *          true if all components should use their opacity value to blend against the 3d scene (and
   *          each other)
   */
  ...
  /**
   * @return the currently rendering component's opacity level. Used by the renderer to alter alpha
   *         values based of component elements.
   */
  public static float getCurrentOpacity() { return UIComponent._currentOpacity; }
  ...
  /**
   * Called when a mouse button is pressed and released in close proximity while the cursor is over
   * this component.
   *
   * @param button
   *          the button that was released
  ...
  /**
   * Looks up the scenegraph for a Hud and asks it to clear us as the currently focused component, if
   * set.
   */
   ...
   */
  public UIComponent getKeyFocusTarget() { return _keyFocusTarget; }

  /**
   * @param target
   *          a component to set as the actual focused component if this component receives focus.
   */
  public void setKeyFocusTarget(final UIComponent target) { _keyFocusTarget = target; }
}
