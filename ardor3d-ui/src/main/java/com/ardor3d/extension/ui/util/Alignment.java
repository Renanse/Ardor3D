...
/**
 * Enumeration useful for describing positioning and alignment to the edges and corners of a
 * rectangular area. This is used in our UI system to align text, images, and handle certain layouts
 * such as the AnchorLayout.
 */
public enum Alignment {
  ...
  /**
   * Determine the correct relative X position for a component being aligned, using this alignment, to
   * another component (or a box to another box, or area... etc. - anything with a "width").
   * 
  ...
  /**
   * Determine the correct relative Y position for a component being aligned, using this alignment, to
   * another component (or a box to another box, or area... etc. - anything with a "height").
   * 
