...
public class ForumLikeMarkupParser implements StyleParser {
  ...
  Comparator<StyleSpan> endSorter =
      (o1, o2) -> o1.getSpanStart() + o1.getSpanLength() - (o2.getSpanStart() + o2.getSpanLength());
      ...
      // end token
        ...
        // COLOR
          ...
          try {
            ...
            buildingSpans.add(new StyleSpan(StyleConstants.KEY_COLOR, ColorRGBA.parseColor(c, null), index, 0));
