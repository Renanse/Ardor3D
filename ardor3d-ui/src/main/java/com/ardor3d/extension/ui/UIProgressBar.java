...
/**
 * This component shows progress as "percent complete" via a proportionally sized bar and an
 * optional text label.
 */
public class UIProgressBar extends UIPanel {
   ...
   *          true for horizontal bar, false for vertical.
   */
  public void setHorizontal(final boolean horizontal) { _horizontal = horizontal; }

  public double getPercentFilled() { return _percentFilled; }
  ...
  public UIPanel getBar() { return _bar; }

  public UILabel getTextLabel() { return _textLabel; }

  public UILabel getBarLabel() { return _barLabel; }

  public UIPanel getMainPanel() { return _mainPanel; }
}
