 ...
 * Changing the selection is allowed via a popup menu shown when the component is clicked on.
 */
public class UIComboBox extends UIPanel {
  ...
  public UIComboBox(final ComboBoxModel model) {
    ...
    _openButton.addActionListener(event -> {
      if (!isEnabled()) {
        return;
      }
      ...
      for (int i = 0; i < _model.size(); i++) {
        ...
        final int index = i;
        item.addActionListener(event1 -> setSelectedIndex(index));
  ...
  public Object getSelectedValue() { return _model.getValueAt(getSelectedIndex()); }
  ...
  public UILabel getValueLabel() { return _valueLabel; }

  public ComboBoxModel getModel() { return _model; }

  public UIButton getOpenButton() { return _openButton; }

  public UIPopupMenu getValuesMenu() { return _valuesMenu; }
  ...
  public void setItemSkinCallback(final SkinningTask callback) { _itemSkinCallback = callback; }

  public SkinningTask getItemSkinCallback() { return _itemSkinCallback; }
}
