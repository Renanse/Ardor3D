...
public class SubTexUtil {
  ...
  /**
   * Draw the given SubTex to the screen at the given location. Use the given width and height instead
   * of those supplied in the SubTex.
   *
   * @param renderer
   *          the renderer to use
   * @param subTex
   ...
   */
  public static void drawSubTex(final Renderer renderer, final SubTex subTex, final int x, final int y, final int width,
      final int height, final ReadOnlyTransform appliedTransform) {
    SubTexUtil.drawSubTex(renderer, subTex, x, y, width, height, false, appliedTransform);
  }

  /**
   * Draw the given SubTex to the screen at the given location. Use the given width and height instead
   * of those supplied in the SubTex. Does not flip vertically.
   *
   * @param renderer
   *          the renderer to use
   * @param subTex
   ...
   * Use the given width and height instead of those supplied in the SubTex.
   *
   * @param renderer
   *          the renderer to use
   * @param subTex
   ...
   */
  public static void drawSubTex(final Renderer renderer, final SubTex subTex, final int x, final int y, final int width,
      final int height, final boolean flipVertical, final ReadOnlyTransform appliedTransform) {
  ...
  /**
   * Draw the given TransformedSubTex, optionally inverted on the Y axis, to the screen at the given
   * location. Use the given width and height instead of those supplied in the TransformedSubTex.
   *
   * @param renderer
   *          the renderer to use
   * @param subTex
