...
/**
 * Defines a group of buttons. This is generally used with radio or toggle buttons to indicate a
 * group wherein only one button should be pressed at a time.
 */
public class ButtonGroup {
   ...
   */
  public Iterator<UIButton> getButtons() { return _buttons.iterator(); }

  /**
   * @return the currently selected button or null if none have been selected yet.
   */
  public UIButton getSelection() { return _selected; }

  /**
   * Sets the selected value for the given button. Only one button in the group may be selected at a
   * time.
   * 
   * @param button
   ...
   */
  public int getButtonCount() { return _buttons.size(); }
}
