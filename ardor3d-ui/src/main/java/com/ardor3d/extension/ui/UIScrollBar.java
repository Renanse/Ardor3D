...
public class UIScrollBar extends UIPanel {
  ...
  public UIScrollBar(final Orientation orientation) {
    ...
    slider.addActionListener(event -> fireChangeEvent());
  }
  ...
  public int getSliderLength() { return sliderLength; }
  ...
  public UIButton getBtTopLeft() { return btTopLeft; }

  public UIButton getBtBottomRight() { return btBottomRight; }
}
