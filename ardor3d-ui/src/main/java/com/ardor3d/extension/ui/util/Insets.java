...
/**
 * This class is patterned after awt's {@link java.awt.Insets Insets} class. It describes the
 * margins on four sides of a rectangular area and is the foundation of our UIBorder class.
 */
public class Insets {
  ...
  public void setLeft(final int size) { _left = size; }

  public void setRight(final int size) { _right = size; }

  public void setTop(final int size) { _top = size; }

  public void setBottom(final int size) { _bottom = size; }
  ...
  public String toString() {
    return String.format("'%1$s': top: %2$d, left: %3$d, bottom: %4$d, right: %5$d", this.getClass().getSimpleName(),
