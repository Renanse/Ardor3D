...
public class UIHud extends Node {
    ...
    protected static final Logger _logger = Logger.getLogger(UIHud.class.getName());
     ...
     */
    protected final List<HudListener> _hudListeners = Lists.newArrayList();
     ...
     */
    protected final List<IPopOver> _popovers = Lists.newArrayList();
