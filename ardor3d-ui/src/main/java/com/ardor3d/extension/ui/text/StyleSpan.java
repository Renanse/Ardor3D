...
public class StyleSpan implements Comparable<StyleSpan> {
  ...
  public int getSpanStart() { return _spanStart; }

  public void setSpanStart(final int spanStart) { _spanStart = spanStart; }

  public int getSpanLength() { return _spanLength; }

  public void setSpanLength(final int length) { _spanLength = length; }

  public String getStyle() { return _style; }

  public void setStyle(final String style) { _style = style; }
