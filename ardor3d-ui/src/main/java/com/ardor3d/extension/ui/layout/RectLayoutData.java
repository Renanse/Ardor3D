...
/**
 * Layout data used to describe a component's positioning relative to a rectangle drawn on the
 * component's parent. The positioning uses percentage based anchor points to form a rectangle on
 * the parent's content area and pixel insets to enlarge or shrink that rectangle.
 */
public class RectLayoutData implements UILayoutData {
  ...
  /**
   * Create new layout data for use in RectLayout. Defaults to anchor to center of component with -10
   * insets on all edges, forming a 20x20 component.
   */
  ...
  /**
   * Set the inset values from the edges of the rectangle described by the min and max anchor points.
   * Positive values move the edge towards the center of the described rectangle.
   *
   * @param top
   *          top edge inset, in pixels
   * @param left
  ...
  /**
   * @return the bottom left corner of the parent rectangle to position this component relative to.
   *         Coordinates are in percent, where X=0.0 means the left edge and X=1.0 means the right
   *         edge, Y=0.0 means the bottom edge and Y=1.0 means the top edge.
   */
  public Vector2 getRelativeMin() { return _relativeMin; }

  /**
   * @return the top right corner of the parent rectangle to position this component relative to.
   *         Coordinates are in percent, where X=0.0 means the left edge and X=1.0 means the right
   *         edge, Y=0.0 means the bottom edge and Y=1.0 means the top edge.
   */
  public Vector2 getRelativeMax() { return _relativeMax; }

  /**
   * @return the insets from the anchor rectangle we will use when calculating the size and position
   *         of this component. A positive value moves that edge closer to the center of the
   *         rectangle.
   */
  public Insets getPixelInsets() { return _pixelInsets; }

  /**
   * Create layout data that centers a component on its parent's center, with a specific width and
   * height.
   *
   * @param childWidth
  ...
  /**
   * Create layout data that positions a component with its top left relative to its parent's top
   * left, with a specific width and height.
   *
   * @param childWidth
   *          desired child component width
   * @param childHeight
  ...
  /**
   * Create layout data that positions a component with its top right relative to its parent's top
   * right, with a specific width and height.
   *
   * @param childWidth
   *          desired child component width
   * @param childHeight
  ...
  /**
   * Create layout data that positions a component with its bottom left relative to its parent's
   * bottom left, with a specific width and height.
   *
   * @param childWidth
   *          desired child component width
   * @param childHeight
  ...
  /**
   * Create layout data that positions a component with its bottom right relative to its parent's
   * bottom right, with a specific width and height.
   *
   * @param childWidth
   *          desired child component width
   * @param childHeight
