...
/**
 * <p>
 * Layout applied to a parent container used to position child components as sub-rectangles pinned to the content area
 * of this component. Child components should have a {@link RectLayoutData} set.
 * </p>
 *
 * <p>
 * Components are laid out by pinning the bottom left and top right corners of the component to two locations in the
 * parent container's content area, forming a sub-rectangle. Insets are then applied to this rectangle, shifting the 4
 * edges further in or out. With this behavior, it is possible to create both statically sized and dynamically sized
 * child components.
 * </p>
 *
 * <p>
 * Example: Set up a 100x30 button and pin it to the center of its parent, regardless of parent size.
 *
 * <pre>
 ...
 *
 * <p>
 * Example: Pin the above button to center of its parent, but set it to a third of the panel wide and 30 pixels tall.
 *
 * <pre>
...
public class RectLayout extends UILayout {
    ...
    /**
     * Do nothing - just use what is given by to the container. We can calculate a min width/height as below in
     * comments, but it is prone to exploding due to recursive dependency (imagine an anchor of -0.2 for example.)
     */
    @Override
