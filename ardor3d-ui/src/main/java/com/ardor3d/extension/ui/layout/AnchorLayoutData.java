...
public class AnchorLayoutData implements UILayoutData {
   ...
   */
  public Alignment getMyPoint() { return _myPoint; }

  public void setMyPoint(final Alignment myPoint) { _myPoint = myPoint; }

  /**
   * @return the component or container to align to
   */
  public UIComponent getParent() { return _parent; }

  public void setParent(final UIComponent parent) { _parent = parent; }

  /**
   * @return the point on the parent to align my point to
   */
  public Alignment getParentPoint() { return _parentPoint; }

  public void setParentPoint(final Alignment parentPoint) { _parentPoint = parentPoint; }
  ...
  public void setXOffset(final int offset) { _xOffset = offset; }
  ...
  public void setYOffset(final int offset) { _yOffset = offset; }
}
