...
/**
 * This backdrop paints a single image on a colored plane behind the component, stretching it and
 * aligning it to the component based on given settings.
 */
public class ImageBackdrop extends SolidBackdrop {
  ...
  public SubTex getImage() { return _image; }

  public void setImage(final SubTex image) { _image = image; }

  public StretchAxis getStretch() { return _axis; }

  public void setStretch(final StretchAxis axis) { _axis = axis; }

  public Alignment getAlignment() { return _alignment; }

  public void setAlignment(final Alignment alignment) { _alignment = alignment; }

  public ReadOnlyColorRGBA getTintColor() { return _tintColor; }
