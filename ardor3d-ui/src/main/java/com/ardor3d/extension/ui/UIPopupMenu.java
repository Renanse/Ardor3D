...
public class UIPopupMenu extends UIContainer implements IPopOver {
  ...
  public SubMenuBehavior getLocalSubMenuBehavior() { return _subMenuBehavior; }

  public void setSubMenuBehavior(final SubMenuBehavior behavior) { _subMenuBehavior = behavior; }
}
