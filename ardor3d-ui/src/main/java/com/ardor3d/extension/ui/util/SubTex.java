...
/**
 * Describes a sub-portion of a full Ardor3D Texture object. This is useful for taking a large image
 * with lots of smaller images in it and reusing that same texture in multiple locations.
 */
public class SubTex {
  ...
  /**
   * The number of pixels of the inside-top of this subtex that is considered a border. Used by some
   * UIBorders and UIBackdrops in 9-slicing.
   */
  private int _borderTop;
  /**
   * The number of pixels of the inside-left of this subtex that is considered a border. Used by some
   * UIBorders and UIBackdrops in 9-slicing.
   */
  private int _borderLeft;
  /**
   * The number of pixels of the inside-bottom of this subtex that is considered a border. Used by
   * some UIBorders and UIBackdrops in 9-slicing.
   */
  private int _borderBottom;
  /**
   * The number of pixels of the inside-right of this subtex that is considered a border. Used by some
   * UIBorders and UIBackdrops in 9-slicing.
   */
   ...
   */
  public SubTex(final Texture texture, final int x, final int y, final int width, final int height, final int borderTop,
    final int borderLeft, final int borderBottom, final int borderRight) {
    _texture = texture;
    _x = x;
    _y = y;
    _width = width;
  ...
  public int getBorderTop() { return _borderTop; }

  public int getBorderLeft() { return _borderLeft; }

  public int getBorderBottom() { return _borderBottom; }

  public int getBorderRight() { return _borderRight; }
   ...
   *
   * @param color
   *          a color to blend our texture with when rendering SubTex objects. The default is null
   *          (which is interpreted as pure white and gives an unaltered version of the texture.)
   */
  ...
  /**
   * @return the uv coordinate, in [0, 1], of the right edge of this SubTex as relates to its master
   *         Texture.
   */
  public float getEndX() { return (_width + _x) / (float) _texture.getImage().getWidth(); }

  /**
   * @return the uv coordinate, in [0, 1], of the top edge of this SubTex as relates to its master
   *         Texture.
   */
  public float getEndY() { return (_height + _y) / (float) _texture.getImage().getHeight(); }

  /**
   * @return the uv coordinate, in [0, 1], of the left edge of this SubTex as relates to its master
   *         Texture.
   */
  public float getStartX() { return _x / (float) _texture.getImage().getWidth(); }

  /**
   * @return the uv coordinate, in [0, 1], of the bottom edge of this SubTex as relates to its master
   *         Texture.
   */
  public float getStartY() { return _y / (float) _texture.getImage().getHeight(); }
}
