...
public class UIDoubleField extends UITextField {
  ...
  public void setMinimumValue(final double value) { _minValue = value; }

  public double getMinimumValue() { return _minValue; }

  public void setMaximumValue(final double value) { _maxValue = value; }

  public double getMaximumValue() { return _maxValue; }

  public void setDecimalPlaces(final int places) { _decimalPlaces = places; }

  public int getDecimalPlaces() { return _decimalPlaces; }

  public boolean isDisplayScientific() { return _displayScientific; }

  public void setDisplayScientific(final boolean displayScientific) { _displayScientific = displayScientific; }
