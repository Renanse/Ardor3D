...
/**
 * Describes a relative transform as a Quaternion-Vector-Vector tuple. We use QVV to make it simpler
 * to do LERP blending.
 */
public class TransformData implements Savable {
  ...
  public Vector3 getTranslation() { return _translation; }
  ...
  @Override
  public Class<? extends TransformData> getClassTag() { return this.getClass(); }
