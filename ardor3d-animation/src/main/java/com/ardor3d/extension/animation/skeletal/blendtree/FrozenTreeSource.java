...
/**
 * A blend tree node that does not update any clips or sources below it in the blend tree. This is
 * useful for freezing an animation, often for purposes of transitioning between two unrelated
 * animations.
 */
