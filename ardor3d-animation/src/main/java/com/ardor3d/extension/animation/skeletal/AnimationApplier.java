...
/**
 * Describes a class that can take information from a manager and its current layers and state and
 * apply it to a given SkeletonPose. The class should not update or modify the manager, but should
 * merely request current state (usually via <i>manager.getCurrentSourceData();</i>)
 */
