...
/**
 * An animation source channel consisting of double value samples. These samples are interpolated
...
public class InterpolatedDoubleChannel extends AbstractAnimationChannel {
  ...
  public double[] getValues() { return _values; }
  ...
  @Override
  public Class<? extends InterpolatedDoubleChannel> getClassTag() { return this.getClass(); }
