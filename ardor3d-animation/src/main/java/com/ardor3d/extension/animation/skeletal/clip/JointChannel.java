...
/**
 * Transform animation channel, specifically geared towards describing the motion of skeleton
 * joints.
 */
...
public class JointChannel extends TransformChannel {
   ...
   */
  public String getJointName() { return _jointName; }
  ...
  @Override
  public Class<? extends JointChannel> getClassTag() { return this.getClass(); }
