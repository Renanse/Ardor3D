 ...
 * condition is met. Each channel can only be in one keyword "state" at a given moment in time.
 */
...
public class TriggerChannel extends AbstractAnimationChannel {
  ...
  public AbstractAnimationChannel getSubchannelByTime(final String name, final float startTime, final float endTime) {
    ...
    // return
    return new TriggerChannel(name, timesArray, keys.toArray(new String[0]));
  }
  ...
  @Override
  public Class<? extends TriggerChannel> getClassTag() { return this.getClass(); }
