...
/**
 * Import utility used for reading and constructing AnimationLayer information for a manager using
 * JavaScript.
 */
public final class JSLayerImporter {
   ...
   * @param input
   *          the input store object, holding things like AnimationClips that the layers might need
   *          for construction.
