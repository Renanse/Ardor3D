...
/**
 * This class essentially just wraps a String->ClipSource HashMap, providing extra logging when a
 * ClipSource is not found, or duplicate ClipSources are added.
 */
public class OutputClipSourceMap extends LoggingMap<String, ClipSource> {
  ...
  /**
   * Add a ClipSource to the store. Logs a warning if a source by the same name was already in the
   * store.
   * 
   * @param source
