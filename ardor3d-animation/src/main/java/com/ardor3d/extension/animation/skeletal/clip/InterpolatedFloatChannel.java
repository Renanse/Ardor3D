...
/**
 * An animation source channel consisting of float value samples. These samples are interpolated
...
public class InterpolatedFloatChannel extends AbstractAnimationChannel {
  ...
  @Override
  public Class<? extends InterpolatedFloatChannel> getClassTag() { return this.getClass(); }
