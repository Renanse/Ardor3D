...
/**
 * A transition that blends over a given time from one animation state to another, synchronizing the
 * target state to the initial state's start time. This is best used with two clips that have
 * similar motions.
 */
