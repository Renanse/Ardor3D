...
public class PSSMCamera extends Camera {
  ...
  /**
   * Calculates the distances from view location for view frustum splits using the "practical split
   * scheme".
   * 
   * @param splitCount
   *          the split count
   ...
   */
  public double[] getSplitDistances() { return _splitDistances; }
   ...
   */
  public double getMaxFarPlaneDistance() { return _maxFarPlaneDistance; }
