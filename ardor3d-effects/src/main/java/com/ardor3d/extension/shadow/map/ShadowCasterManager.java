...
public class ShadowCasterManager {
    ...
    protected List<WeakReference<Spatial>> _spatialRefs = new ArrayList<WeakReference<Spatial>>();
    protected List<WeakReference<Spatial>> _cleanup = new ArrayList<WeakReference<Spatial>>();
    ...
    public void addSpatial(final Spatial spatial) {
        ...
        _spatialRefs.add(new WeakReference<Spatial>(spatial));
