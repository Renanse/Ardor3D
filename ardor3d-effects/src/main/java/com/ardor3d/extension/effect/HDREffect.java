...
public class HDREffect extends RenderEffect {
  ...
  private void initTargets(final EffectManager manager) {
    ...
    final RenderTarget_Texture2D downsampled =
        new RenderTarget_Texture2D(downsampledWidth, downsampledHeight, TextureStoreFormat.RGBA16F);
  ...
  public String getShaderDirectory() { return shaderDirectory; }

  public void setShaderDirectory(final String shaderDirectory) { this.shaderDirectory = shaderDirectory; }
}
