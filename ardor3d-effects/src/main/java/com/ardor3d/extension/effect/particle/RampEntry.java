...
public class RampEntry implements Savable {
   ...
   *
   * @param offset
   *          amount of time (as a percent of total lifetime) between the last appearance and this
   *          one.
   */
  ...
  public void setSize(final double size) { _size = size; }

  public boolean hasSizeSet() {
    return _size != DEFAULT_SIZE;
  }

  public double getSpin() { return _spin; }

  public void setSpin(final double spin) { _spin = spin; }
  ...
  public void setMass(final double mass) { _mass = mass; }
  ...
  @Override
  public Class<? extends RampEntry> getClassTag() { return getClass(); }
