...
/**
 * The WaterNode handles rendering of a water effect on all of it's children. What is reflected in
 * the water is controlled through setReflectedScene/addReflectedScene. The skybox (if any) needs to
 * be explicitly set through setSkybox since it needs to be relocated when rendering the reflection.
 * The water is treated as a plane no matter what the geometry is, which is controlled through the
 * water node plane equation settings.
 */
public class WaterNode extends Node {
  ...
  // "com/ardor3d/extension/effect/water/projectedwatershader_refraction";
   ...
   * @param renderScale
   *          how many times smaller the reflection/refraction textures should be compared to the main
   *          display
   * @param useProjectedShader
   *          true - use the projected setup for variable height water meshes, false - use the flast
   *          shader setup
   * @param useRefraction
  ...
  private void modifyProjectionMatrix(final Vector4 clipPlane) {
    ...
    final ReadOnlyMatrix4 modelViewMatrixInvTrans =
        tRenderer.getCamera().getViewMatrix().invert(tmpMatrix).transposeLocal();
   ...
   */
  public void setSkybox(final Node skyBox) { this.skyBox = skyBox; }

  public Camera getCam() { return cam; }

  public void setCam(final Camera cam) { this.cam = cam; }

  public ColorRGBA getWaterColorStart() { return waterColorStart; }

  /**
   * Color to use when the incident angle to the surface is low
   */
  public void setWaterColorStart(final ColorRGBA waterColorStart) { this.waterColorStart = waterColorStart; }

  public ColorRGBA getWaterColorEnd() { return waterColorEnd; }

  /**
   * Color to use when the incident angle to the surface is high
   */
  public void setWaterColorEnd(final ColorRGBA waterColorEnd) { this.waterColorEnd = waterColorEnd; }

  public double getHeightFalloffStart() { return heightFalloffStart; }
  ...
  public double getHeightFalloffSpeed() { return heightFalloffSpeed; }
  ...
  public ReadOnlyVector3 getNormal() { return waterPlane.getNormal(); }
  ...
  public double getSpeedReflection() { return speedReflection; }
   ...
   */
  public void setSpeedReflection(final double speedReflection) { this.speedReflection = speedReflection; }

  public double getSpeedRefraction() { return speedRefraction; }
   ...
   */
  public void setSpeedRefraction(final double speedRefraction) { this.speedRefraction = speedRefraction; }

  public double getWaterMaxAmplitude() { return waterMaxAmplitude; }
   ...
   *          Maximum amplitude
   */
  public void setWaterMaxAmplitude(final double waterMaxAmplitude) { this.waterMaxAmplitude = waterMaxAmplitude; }

  public double getClipBias() { return clipBias; }

  public void setClipBias(final double clipBias) { this.clipBias = clipBias; }

  public Plane getWaterPlane() { return waterPlane; }

  public void setWaterPlane(final Plane waterPlane) { this.waterPlane = waterPlane; }

  public Vector3 getTangent() { return tangent; }

  public void setTangent(final Vector3 tangent) { this.tangent = tangent; }

  public Vector3 getBinormal() { return binormal; }

  public void setBinormal(final Vector3 binormal) { this.binormal = binormal; }

  public Texture getTextureReflect() { return textureReflect; }

  public Texture getTextureRefract() { return textureRefract; }

  public Texture getTextureDepth() { return textureDepth; }
  ...
  public boolean isUseFadeToFogColor() { return useFadeToFogColor; }

  public boolean isUseReflection() { return useReflection; }
  ...
  public boolean isUseRefraction() { return useRefraction; }
  ...
  public void setRenderScale(final int renderScale) { this.renderScale = renderScale; }

  public boolean isUseProjectedShader() { return useProjectedShader; }
  ...
  public double getReflectionThrottle() { return reflectionThrottle; }

  public void setReflectionThrottle(final double reflectionThrottle) { this.reflectionThrottle = reflectionThrottle; }

  public double getRefractionThrottle() { return refractionThrottle; }

  public void setRefractionThrottle(final double refractionThrottle) { this.refractionThrottle = refractionThrottle; }

  public TextureState getTextureState() { return textureState; }

  public void setTextureState(final TextureState textureState) { this.textureState = textureState; }

  public void updateCamera() {
    tRenderer.getCamera().setFrustum(cam);
  }

  public void setNormalmapTexture(final Texture normalmapTexture) { this.normalmapTexture = normalmapTexture; }

  public Texture getNormalmapTexture() { return normalmapTexture; }

  public void setDudvTexture(final Texture dudvTexture) { this.dudvTexture = dudvTexture; }

  public Texture getDudvTexture() { return dudvTexture; }

  public void setFoamTexture(final Texture foamTexture) { this.foamTexture = foamTexture; }

  public Texture getFoamTexture() { return foamTexture; }

  /**
   * @return the normalMapTextureString
   */
  public String getNormalMapTextureString() { return normalMapTextureString; }
   ...
   */
  public String getDudvMapTextureString() { return dudvMapTextureString; }
   ...
   */
  public String getFoamMapTextureString() { return foamMapTextureString; }
  ...
  public boolean isDoBlurReflection() { return doBlurReflection; }

  public void setDoBlurReflection(final boolean doBlurReflection) { this.doBlurReflection = doBlurReflection; }

  public float getBlurSampleDistance() { return blurSampleDistance; }
