...
public class Triangle implements Cloneable, Savable, Externalizable, ReadOnlyTriangle, Poolable {
  ...
  @Override
  public ReadOnlyVector3 getA() { return _pointA; }

  @Override
  public ReadOnlyVector3 getB() { return _pointB; }

  @Override
  public ReadOnlyVector3 getC() { return _pointC; }

  /**
   * Obtains the unit length normal vector of this triangle... Will create and recalculate this normal
   * vector if this is the first request, or if one of the points on the triangle has changed since
   * the last request.
   *
  ...
  /**
   * Obtains the center point of this triangle... Will create and recalculate this point if this is
   * the first request, or if one of the points on the triangle has changed since the last request.
   */
  @Override
  ...
  public String toString() {
    return "com.ardor3d.math.Triangle [A: " + _pointA + " - B: " + _pointB + " - C: " + _pointC + " - Index: " + _index
        + "]";
  }

  /**
   * @return returns a unique code for this triangle object based on its values. If two triangles have
   *         the same points and index, they will return the same hash code value.
   */
  @Override
  public int hashCode() {
    int result = 17;
  ...
  @Override
  public Class<? extends Triangle> getClassTag() { return this.getClass(); }
  ...
  /**
   * @return An instance of Triangle that is intended for temporary use in calculations and so forth.
  ...
  /**
   * Releases a Triangle back to be used by a future call to fetchTempInstance. TAKE CARE: this
   * Triangle object should no longer have other classes referencing it or "Bad Things" will happen.
   *
   * @param tri
