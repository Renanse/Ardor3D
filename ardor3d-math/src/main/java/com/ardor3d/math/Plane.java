...
/**
 * A representation of a mathematical plane using a normal vector and a plane constant (d) whose
 * absolute value represents the distance from the origin to the plane. It is generally calculated
...
public class Plane implements Cloneable, Savable, Externalizable, ReadOnlyPlane, Poolable {
   ...
   */
  @Override
  public ReadOnlyVector3 getNormal() { return _normal; }
   ...
   * @param constant
   */
  public void setConstant(final double constant) { _constant = constant; }
  ...
  /**
   * @param point
   * @return the distance from this plane to a provided point. If the point is on the negative side of
   *         the plane the distance returned is negative, otherwise it is positive. If the point is on
  ...
  /**
   * Check a plane... if it is null or its constant, or the doubles of its normal are NaN or infinite,
  ...
  /**
   * @return returns a unique code for this plane object based on its values. If two planes are
  ...
  @Override
  public Class<? extends Plane> getClassTag() { return this.getClass(); }
  ...
  /**
   * @return An instance of Plane that is intended for temporary use in calculations and so forth.
  ...
  /**
   * Releases a Plane back to be used by a future call to fetchTempInstance. TAKE CARE: this Plane
