...
/**
 * <code>Ring</code> defines a flat ring or disk within three dimensional space that is specified
 * via the ring's center point, an up vector, an inner radius, and an outer radius.
 */
...
public class Ring implements Cloneable, Savable, Externalizable, ReadOnlyRing, Poolable {
  ...
  /**
   * Constructor creates a new <code>Ring</code> lying on the XZ plane, centered at the origin, with
   * an inner radius of zero and an outer radius of one (a unit disk).
   */
  public Ring() {
    _innerRadius = 0.0;
    _outerRadius = 1.0;
  ...
  /**
   * Constructor creates a new <code>Ring</code> with defined center point, up vector, and inner and
   * outer radii.
   *
   * @param center
   ...
   *          the ring's inner radius.
   */
  public void setInnerRadius(final double innerRadius) { _innerRadius = innerRadius; }
   ...
   */
  @Override
  public double getOuterRadius() { return _outerRadius; }
   ...
   *          the ring's outer radius.
   */
  public void setOuterRadius(final double outerRadius) { _outerRadius = outerRadius; }
  ...
  /**
   * Check a ring... if it is null or its radii, or the doubles of its center or up are NaN or
  ...
  /**
   * @return returns a unique code for this ring object based on its values. If two rings are
  ...
  @Override
  public Class<? extends Ring> getClassTag() { return this.getClass(); }

  @Override
  public void write(final OutputCapsule capsule) throws IOException {
    capsule.write(_center, "center", (Vector3) Vector3.ZERO);
    capsule.write(_up, "up", (Vector3) Vector3.UNIT_Z);
  ...
  public void read(final InputCapsule capsule) throws IOException {
    ...
    _up.set(capsule.readSavable("up", (Vector3) Vector3.UNIT_Z));
  ...
  /**
   * @return An instance of Ring that is intended for temporary use in calculations and so forth.
  ...
  /**
   * Releases a Ring back to be used by a future call to fetchTempInstance. TAKE CARE: this Ring
