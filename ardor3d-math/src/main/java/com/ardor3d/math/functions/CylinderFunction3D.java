 ...
 * ring stretching infinitely along the Y axis. The spacing between rings is controlled by the
 * frequency. A higher frequency gives more rings in the same amount of space.
 */
public class CylinderFunction3D implements Function3D {
  ...
  public double eval(final double x, final double y, final double z) {
    ...
    // return a value between -1 and 1, where 1 means the radius length was on an integer value and -1
    // means it was
