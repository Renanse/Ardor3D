 ...
 * jas for use with libnoise, then modified for use in Ardor3D in 2009.
 */
public class RidgeFunction3D implements Function3D {
  ...
  public double getOctaves() { return _octaves; }

  public void setOctaves(final double octaves) { _octaves = octaves; }
  ...
  public void setGain(final double gain) { _gain = gain; }
