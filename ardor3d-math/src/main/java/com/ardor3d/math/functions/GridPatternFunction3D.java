...
/**
 * Creates a pattern in the XY plane that is defined by a user-provided grid of values. This is not
 * really 3D, since it ignores the z factor.
 */
public class GridPatternFunction3D implements Function3D {
  ...
  /**
   * Gets a value from the user-defined grid. This is an extension point for subclasses which may need
   * to perform a calculation of some type on that value before returning it. The default
   * implementation simply returns the value from the grid at gridX/gridY.
   */
