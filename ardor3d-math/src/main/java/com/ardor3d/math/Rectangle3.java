...
/**
 * Defines a finite plane within three dimensional space that is specified via three points (A, B,
 * C). These three points define a triangle with the forth point defining the rectangle ((B + C) -
 * A.
 */
...
public class Rectangle3 implements Cloneable, Savable, Externalizable, ReadOnlyRectangle3, Poolable {
  ...
  private static final ObjectPool<Rectangle3> RECTANGLE_POOL =
      ObjectPool.create(Rectangle3.class, MathConstants.maxMathPoolSize);
  ...
  /**
   * Constructor creates a new Rectangle3 with defined A, B, and C points that define the area of the
   * rectangle.
   *
   * @param a
   ...
   */
  @Override
  public ReadOnlyVector3 getA() { return _a; }
   ...
   */
  @Override
  public ReadOnlyVector3 getB() { return _b; }
   ...
   */
  @Override
  public ReadOnlyVector3 getC() { return _c; }
  ...
  public void write(final OutputCapsule capsule) throws IOException {
    capsule.write(_a, "a", (Vector3) Vector3.ZERO);
    capsule.write(_b, "b", (Vector3) Vector3.ZERO);
    capsule.write(_c, "c", (Vector3) Vector3.ZERO);
  }

  @Override
  public void read(final InputCapsule capsule) throws IOException {
    _a.set(capsule.readSavable("a", (Vector3) Vector3.ZERO));
    _b.set(capsule.readSavable("b", (Vector3) Vector3.ZERO));
    _c.set(capsule.readSavable("c", (Vector3) Vector3.ZERO));
  }

  @Override
  public Class<? extends Rectangle3> getClassTag() { return this.getClass(); }
  ...
  /**
   * @return An instance of Rectangle3 that is intended for temporary use in calculations and so
   *         forth. Multiple calls to the method should return instances of this class that are not
   *         currently in use.
   */
  public static Rectangle3 fetchTempInstance() {
  ...
  /**
   * Releases a Rectangle3 back to be used by a future call to fetchTempInstance. TAKE CARE: this
   * object should no longer have other classes referencing it or "Bad Things" will happen.
   *
   * @param rectangle
   *          the Rectangle3 to release.
   */
  public static void releaseTempInstance(final Rectangle3 rectangle) {
    if (MathConstants.useMathPools) {
