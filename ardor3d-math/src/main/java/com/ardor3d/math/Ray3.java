...
public class Ray3 extends Line3Base implements ReadOnlyRay3, Poolable {
   ...
   * @return the distance from our origin to the primitive or POSITIVE_INFINITY if we do not
   *         intersect.
   */
  @Override
   ...
   * @param pointC
   * @param locationStore
   *          if not null, and this ray intersects, the point of intersection is calculated and stored
   *          in this Vector3
   ...
   * @param locationStore
   *          if not null, and this ray intersects, the point of intersection is calculated and stored
   *          in this Vector3 as (t, u, v) where t is the distance from the _origin to the point of
   *          intersection and (u, v) is the intersection point on the triangle plane.
   * @return true if this ray intersects a triangle formed by the given three points.
   * @throws NullPointerException
   *           if any of the points are null.
   */
   ...
   *          if not null, and this ray intersects, the point of intersection is calculated and stored
   *          in this Vector3
   * @return true if this ray intersects a triangle formed by the given three points. The points are
   ...
   *          in this Vector3 as (t, u, v) where t is the distance from the _origin to the point of
   *          intersection and (u, v) is the intersection point on the triangle plane.
   * @return true if this ray intersects a quad formed by the given four points. The points are
   *         assumed to be coplanar.
   * @throws NullPointerException
   *           if any of the points are null.
   */
   ...
   *           if any of the points are null.
   */
  protected boolean intersects(final ReadOnlyVector3 pointA, final ReadOnlyVector3 pointB, final ReadOnlyVector3 pointC,
   ...
   * @param plane
   * @param locationStore
   *          if not null, and this ray intersects the plane, the world location of the point of
   *          intersection is stored in this vector.
  ...
  /**
   * @return An instance of Ray that is intended for temporary use in calculations and so forth.
