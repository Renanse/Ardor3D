...
public abstract class SWTImageUtil {
  ...
  /**
   * Convert the given Ardor3D Image to a List of ImageData objects. It is a List because Ardor3D
   * Images may contain multiple layers (for example, in the case of cube maps or 3D textures).
   *
   * @param input
  ...
  /**
   * Convert the given Ardor3D Image to a List of ImageData objects. It is a List because Ardor3D
   * Images may contain multiple layers (for example, in the case of cube maps or 3D textures). The
   * given SWT Color is used to modulate or "tint" the returned image.
   *
