 ...
 * </pre>
 *
 * @see <a href="http://en.wikipedia.org/wiki/Cubic_Hermite_spline#Catmull.E2.80.93Rom_spline">Cubic
 *      Hermite spline - Wikipedia, the free encyclopedia</a>
 */
public class CatmullRomSpline implements Spline {

  /**
   * @see #interpolate(ReadOnlyVector3, ReadOnlyVector3, ReadOnlyVector3, ReadOnlyVector3, double,
   *      Vector3)
   */
  @Override
   ...
   * @param t
   *          <code>0.0 <= t <= 1.0</code>, if t <= 0.0 then result will be contain exact same values
   *          as p1 and if its >= 1.0 it will contain the exact same values as p2.
   * @param result
