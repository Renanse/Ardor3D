...
public abstract class GraphFactory {
  ...
  /**
   * Creates and sets up a texture to be used as the texture for a given grapher. Also applies
   * appropriate texture filter modes. (NearestNeighborNoMipMaps and Bilinear)
   *
   * @param grapher
  ...
  /**
   * Sets up a Quad to be used as the display surface for a grapher. Puts it in the ortho mode, sets
   * up UVs, and sets up a TextureState and an alpha transparency BlendState.
   *
   * @param quad
   *          the Quad to use
   * @param graphTexture
