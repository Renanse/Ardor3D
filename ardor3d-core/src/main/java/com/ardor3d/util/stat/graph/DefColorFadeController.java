 ...
 * When coupled with an appropriate BlendState, this can be used to fade in and out unlit objects.
 * </p>
 *
 * <p>
...
public class DefColorFadeController implements SpatialController<Spatial> {
   ...
   * @param rate
   *          the amount, per second, to change the alpha. This value will be have its sign flipped if
   *          it is not the appropriate direction given the current default color's alpha.
   */
