...
public class MultiStatSample {
  ...
  public void setTimeElapsed(final double time) { _elapsedTime = time; }
  ...
  public Set<StatType> getStatTypes() { return _values.keySet(); }

  public double getElapsedTime() { return _elapsedTime; }
}
