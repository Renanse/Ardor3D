...
/**
 * <code>TextureKey</code> provides a way for the TextureManager to cache and retrieve
 * <code>Texture</code> objects.
 */
...
final public class TextureKey implements Savable {
  ...
  /**
   * Get a new unique TextureKey. This is meant for use by RTT and other situations where we know we
   * are making a unique texture.
   *
   * @param minFilter
   ...
   */
  public Set<RenderContextRef> getContextRefs() { return _idCache.getContextRefs(); }
  ...
  public Texture.MinificationFilter getMinificationFilter() { return _minFilter; }

  public TextureStoreFormat getFormat() { return _format; }
   ...
   */
  public ResourceSource getSource() { return _source; }
  ...
  @Override
  public Class<? extends TextureKey> getClassTag() { return this.getClass(); }
