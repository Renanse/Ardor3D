...
public interface ResourceSource extends Savable {
  ...
  /**
   * Generate and return a new ResourceSource pointing to a named resource that is relative to this
   * object's resource.
   * 
   * @param name
   *          the name of the resource we want. eg. "./mypic.jpg" etc.
   * @return the relative resource, or null if none is found. Will also return null if this
   *         ResourceSource type does not support relative source.
   */
