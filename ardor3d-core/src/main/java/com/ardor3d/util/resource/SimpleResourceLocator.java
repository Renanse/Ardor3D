 ...
 * cannot find the path relative to the location, it successively omits the starting components of
 * the relative path until it can find a resources with such a trimmed path. If no resource is found
 * with this method null is returned.
 */
public class SimpleResourceLocator implements ResourceLocator {
  ...
  public URI getBaseDir() { return _baseDir; }
