...
/**
 * ResourceSource that pulls its content from a String. This source type does not support relative
 * sources.
 */
public class StringResourceSource implements ResourceSource {
   ...
   *          the data this source should return.
   * @param type
   *          the type for this source. Usually a file extension such as .txt or .js. Required for
   *          generic loading when multiple resource handlers could be used.
   */
   ...
   */
  @Override
  public String getName() { return "string resource"; }
  ...
  @Override
  public Class<?> getClassTag() { return StringResourceSource.class; }
