...
/**
 * The DOMSerializer was based primarily off the DOMSerializer.java class from the "Java and XML"
 * 3rd Edition book by Brett McLaughlin, and Justin Edelson. Some modifications were made to support
 * formatting of elements and attributes.
 *
 */
public class DOMSerializer {
  ...
  public void setLineSeparator(final String lineSeparator) { _lineSeparator = lineSeparator; }
