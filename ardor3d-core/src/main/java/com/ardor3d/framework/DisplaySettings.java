...
public class DisplaySettings {
  ...
  public DisplaySettings(final int width, final int height, final int colorDepth, final int frequency,
    final int alphaBits, final int depthBits, final int stencilBits, final int samples, final boolean fullScreen,
    final boolean stereo, final CanvasRenderer shareContext) {
    _width = width;
    _height = height;
    _colorDepth = colorDepth;
    _frequency = frequency;
  ...
  public CanvasRenderer getShareContext() { return _shareContext; }
  ...
  public int getAlphaBits() { return _alphaBits; }

  public int getDepthBits() { return _depthBits; }

  public int getStencilBits() { return _stencilBits; }

  public int getSamples() { return _samples; }

  public boolean isFullScreen() { return _fullScreen; }

  public boolean isStereo() { return _stereo; }
  ...
  public DisplaySettings resizedCopy(final int width, final int height) {
    return new DisplaySettings(width, height, _colorDepth, _frequency, _alphaBits, _depthBits, _stencilBits, _samples,
        _fullScreen, _stereo, _shareContext);
  }
}
