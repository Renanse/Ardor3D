...
/**
 * This interface defines the View, and should maybe be called the ViewUpdater. It owns the
 * rendering phase, and controls all interactions with the Renderer.
 */
public interface Canvas extends IDpiScaleProvider {
  ...
  /**
   * Ask the canvas to render itself. Note that this may occur in another thread and therefore a latch
   * is given so the caller may know when the draw has completed.
   *
   * @param latch
