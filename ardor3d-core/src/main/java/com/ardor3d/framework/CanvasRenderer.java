...
public interface CanvasRenderer {
  ...
  /**
   * Returns the camera being used by this canvas renderer. Modifying the returned {@link Camera}
   * instance effects the view being rendered, so this method can be used to move the camera, etc.
   *
   ...
   * ContextManager.getCurrentContext().getCurrentCanvasRenderer() but with null checks for current
   * context.
   *
   * @return the CanvasRenderer on the current RenderContext.
   */
  static CanvasRenderer getCurrent() {
