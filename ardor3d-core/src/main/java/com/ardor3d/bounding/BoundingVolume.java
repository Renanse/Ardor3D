...
public abstract class BoundingVolume implements Serializable, Savable {
   ...
   *
   */
  public int getCheckPlane() { return _checkPlane; }
   ...
   * @param value
   */
  public final void setCheckPlane(final int value) { _checkPlane = value; }
  ...
  /**
   *
   * <code>whichSide</code> returns the side on which the bounding volume lies on a plane. Possible
   * values are POSITIVE_SIDE, NEGATIVE_SIDE, and NO_SIDE.
   *
   * @param plane
  ...
  /**
   *
   * <code>computeFromPoints</code> generates a bounding volume that encompasses a collection of
   * points.
   *
   * @param points
  ...
  /**
   * <code>merge</code> combines two bounding volumes into a single bounding volume that contains both
   * this bounding volume and the parameter volume.
   *
   * @param volume
  ...
  /**
   * <code>mergeLocal</code> combines two bounding volumes into a single bounding volume that contains
   * both this bounding volume and the parameter volume. The result is stored locally.
   *
   * @param volume
   *          the volume to combine.
   * @return this
  ...
  /**
   * @return the distance from the center of this bounding volume to its further edge/corner. Similar
   *         to converting this BoundingVolume to a sphere and asking for radius.
   */
  public abstract double getRadius();

  public final ReadOnlyVector3 getCenter() { return _center; }
  ...
  /**
   * determines if this bounding volume and a second given volume are intersecting. Intersecting
   * being: one volume contains another, one volume overlaps another or one volume touches another.
   *
   * @param bv
   ...
   * @param ray
   *          the ray to test.
   * @return an IntersectionRecord containing information about any intersections made by the given
   *         Ray with this bounding
   */
  ...
  @Override
  public Class<? extends BoundingVolume> getClassTag() { return this.getClass(); }
