...
public abstract class AbstractGestureEvent {
     ...
     *            if true, this is the beginning of the associated event. Not all events will have a start.
     * @param bounds
     *            the bounds of the touches involved in this event - the x and y will be the center of the interaction
     *            and the width and height are the dimensions of the rectangle centered at x,y defined by the touches
    ...
    public int getMinX() {
        return _bounds.getX() - _bounds.getWidth() / 2;
    }
    ...
    public int getMinY() {
        return _bounds.getY() - _bounds.getHeight() / 2;
    }
    ...
    public ReadOnlyRectangle2 getBounds() {
        return _bounds;
    }
}
