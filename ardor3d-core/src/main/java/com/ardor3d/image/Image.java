...
/**
 * <code>Image</code> defines a data format for a graphical image. The image is defined by a format,
 * a height and width, and the image data. The width and height must be greater than 0. The data is
 * contained in a byte buffer, and should be packed before creation of the image object.
 *
 */
public class Image implements Serializable, Savable {
  ...
  /**
   * Constructor instantiates a new <code>Image</code> object. The attributes of the image are defined
   * during construction.
   *
   * @param format
  ...
  /**
   * Sets the mipmap data sizes stored in this image's data buffer. Mipmaps are stored sequentially,
   * and the first mipmap is the main image data. To specify no mipmaps, pass null.
   *
   * @param mipMapSizes
  ...
  /**
   * <code>setHeight</code> sets the height value of the image. It is typically a good idea to try to
  ...
  /**
   * <code>setDepth</code> sets the depth value of the image. It is typically a good idea to try to
   * keep this as a multiple of 2. This is used for 3d images.
   *
   * @param depth
   *          the depth of the image.
   */
  public void setDepth(final int depth) { _depth = depth; }

  /**
   * <code>setWidth</code> sets the width value of the image. It is typically a good idea to try to
   * keep this as a multiple of 2.
   *
   * @param width
   *          the width of the image.
   ...
   * @see ImageDataFormat
   */
  public ImageDataFormat getDataFormat() { return _format; }
   ...
   * @see PixelDataType
   */
  public PixelDataType getDataType() { return _type; }
  ...
  /**
   * <code>getData</code> returns the data for this image. If the data is undefined, null will be
   * returned.
   *
   * @return the data for this image.
   */
  public List<ByteBuffer> getData() { return _data; }
  ...
  /**
   * <code>getData</code> returns the data for this image at a given index. If the data is undefined,
  ...
  @Override
  public Class<? extends Image> getClassTag() { return this.getClass(); }
}
