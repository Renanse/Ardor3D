...
public class RGBE {
    ...
    public static class Header {
        ...
        private Header(final int valid, final String programType, final float gamma, final float exposure,
    ...
    public static void readPixelsRawRLE(final DataInputStream in, final byte[] data, int offset,
            final int scanline_width, int num_scanlines) throws IOException {
        final byte[] rgbe = new byte[4];
