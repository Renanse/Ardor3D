...
class DdsPixelFormat {
  ...
  // Used in some older DDS files for alpha channel only uncompressed data (dwRGBBitCount contains the
  // alpha channel
  // bitcount; dwABitMask contains valid data)
  final static int DDPF_ALPHA = 0x2;
  // Texture contains compressed RGB data; dwFourCC contains valid data.
  final static int DDPF_FOURCC = 0x4;
  // Texture contains uncompressed RGB data; dwRGBBitCount and the RGB masks (dwRBitMask, dwGBitMask,
  // dwBBitMask)
  // contain valid data.
  ...
  // Used in some older DDS files for single channel color uncompressed data (dwRGBBitCount contains
  // the luminance
  // channel bit count; dwRBitMask contains the channel mask). Can be combined with DDPF_ALPHAPIXELS
  // for a two channel
  // DDS file.
