...
/**
 *
 * <code>ColorMipMapGenerator</code> is useful for producing textures where consecutive mipmaps are
 * different colors, allowing you to visually see how mipmaps are used in a scene.
 *
 */
public abstract class ColorMipMapGenerator {

  /**
   * Generates an ardor3d Image object containing a mipmapped Image. Each mipmap is a solid color. The
   * first X mipmap colors are defined in topColors, any remaining mipmaps are a shade of default
   * color.
   *
   * @param size
