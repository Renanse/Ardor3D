...
/**
 * <code>CollisionResults</code> stores the results of a collision test by storing an ArrayList of
 * CollisionData.
 */
public abstract class CollisionResults {
  ...
  /**
   * <code>addCollisionData</code> places a new <code>CollisionData</code> object into the results
   * list.
   * 
   * @param col
  ...
  /**
   * 
   * <code>addCollision</code> is an abstract method whose intent is the subclass determines what to
   * do when two Mesh object's bounding volumes are determined to intersect.
   * 
   * @param s
  ...
  /**
   * 
   * <code>processCollisions</code> is an abstract method whose intent is the subclass defines how to
   * process the collision data that has been collected since the last clear.
   * 
   * 
   */
