...
public class TriangleTriangleIntersect {
  ...
  /**
   * This method tests for the intersection between two triangles defined by their vertices. Converted
   * to java from C code found at http://jgt.akpeters.com/papers/Moller97/
   * 
   * @param v0
  ...
  private static boolean newComputeIntervals(final double vv0, final double vv1, final double vv2, final double d0,
      final double d1, final double d2, final double d0d1, final double d0d2, final Vector3 abc, final Vector2 x0x1) {
    if (d0d1 > 0.0f) {
  ...
  private static boolean edgeAgainstTriEdges(final double[] v0, final double[] v1, final double[] u0, final double[] u1,
