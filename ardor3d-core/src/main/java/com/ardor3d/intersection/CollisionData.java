...
/**
 * CollisionData contains information about a collision between two Mesh objects. The mesh that was
 * hit by the relevant Mesh (the one making the collision check) is referenced as well as an
 * ArrayList for the triangles that collided.
 */
public class CollisionData {
  ...
  public Mesh getTargetMesh() { return _targetMesh; }

  public Mesh getSourceMesh() { return _sourceMesh; }

  public List<PrimitiveKey> getSourcePrimitives() { return _sourcePrimitives; }

  public List<PrimitiveKey> getTargetPrimitives() { return _targetPrimitives; }
}
