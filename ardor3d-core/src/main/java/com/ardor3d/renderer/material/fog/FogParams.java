...
public class FogParams implements IUniformSupplier {
  ...
  public FogParams() {
    ...
    _cachedUniforms
        .add(new UniformRef("start", UniformType.Float1, UniformSource.Supplier, (Supplier<Float>) this::getStart));
    _cachedUniforms
        .add(new UniformRef("end", UniformType.Float1, UniformSource.Supplier, (Supplier<Float>) this::getEnd));
    _cachedUniforms
        .add(new UniformRef("density", UniformType.Float1, UniformSource.Supplier, (Supplier<Float>) this::getDensity));
  ...
  public ReadOnlyColorRGBA getColor() { return _fogColor; }

  public void setStart(final float start) { _start = start; }

  public float getStart() { return _start; }

  public void setEnd(final float end) { _end = end; }

  public float getEnd() { return _end; }

  public void setDensity(final float density) { _density = density; }

  public float getDensity() { return _density; }

  public void setFunction(final DensityFunction function) { _function = function; }

  public DensityFunction getFunction() { return _function; }

  public int getFunctionOrdinal() { return _function.ordinal(); }
