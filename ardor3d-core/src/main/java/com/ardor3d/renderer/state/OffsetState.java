...
public class OffsetState extends RenderState {
  ...
  /**
   * Sets an offset param to the zbuffer to be used when comparing an incoming fragment for depth
   * buffer pass/fail.
   * 
   * @param offset
   *          Is multiplied by an implementation-specific value to create a constant depth offset. The
   *          initial value is 0.
   */
   ...
   */
  public float getFactor() { return _factor; }
   ...
   */
  public float getUnits() { return _units; }
  ...
  @Override
  public StateType getType() { return StateType.Offset; }
