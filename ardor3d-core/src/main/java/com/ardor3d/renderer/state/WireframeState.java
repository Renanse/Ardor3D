...
/**
 * <code>WireframeState</code> maintains whether a node and it's children should be drawn in
 * wireframe or solid fill. By default all nodes are rendered solid.
 */
public class WireframeState extends RenderState {
  ...
  @Override
  public StateType getType() { return StateType.Wireframe; }
