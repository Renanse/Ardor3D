...
/**
 * The StencilState RenderState allows the user to set the attributes of the stencil buffer of the
 * renderer. The Stenciling is similar to Z-Buffering in that it allows enabling and disabling
 * drawing on a per pixel basis. You can use the stencil plane to mask out portions of the rendering
 * to create special effects, such as outlining or planar shadows. Our stencil state supports
 * setting operations for front and back facing polygons separately. If your card does not support
 * setting faces independently, the front face values will be used for both sides.
 */
public class StencilState extends RenderState {
  ...
  public enum StencilOperation {
    ...
    Zero,
    /**
     * A stencil function result that sets the stencil buffer value to ref, as specified by stencil
     * function.
     */
    Replace,
    /**
    ...
    Decrement,
    /**
     * A stencil function result that increments the current stencil buffer value and wraps around to
     * the lowest stencil value if it reaches the max. (if the renderer does not support stencil wrap,
     * we'll fall back to Increment)
     */
    IncrementWrap,
    /**
     * A stencil function result that decrements the current stencil buffer and wraps around to the
     * highest stencil value if it reaches the min. value. (if the renderer does not support stencil
     * wrap, we'll fall back to Decrement)
     */
    DecrementWrap,
    /**
  ...
  @Override
  public StateType getType() { return StateType.Stencil; }
  ...
  /**
   * Specifies stencil action when both the stencil test and the depth test pass, or when the stencil
   ...
   */
  public StencilFunction getStencilFunctionFront() { return _stencilFunctionFront; }
   ...
   */
  public int getStencilReferenceFront() { return _stencilReferenceFront; }
   ...
   */
  public int getStencilWriteMaskFront() { return _stencilWriteMaskFront; }
   ...
   */
  public int getStencilFuncMaskFront() { return _stencilFuncMaskFront; }
   ...
   */
  public StencilOperation getStencilOpFailFront() { return _stencilOpFailFront; }
   ...
   */
  public StencilOperation getStencilOpZFailFront() { return _stencilOpZFailFront; }
   ...
   */
  public StencilOperation getStencilOpZPassFront() { return _stencilOpZPassFront; }
   ...
   */
  public StencilFunction getStencilFunctionBack() { return _stencilFunctionBack; }
   ...
   */
  public int getStencilReferenceBack() { return _stencilReferenceBack; }
   ...
   */
  public int getStencilWriteMaskBack() { return _stencilWriteMaskBack; }
   ...
   */
  public int getStencilFuncMaskBack() { return _stencilFuncMaskBack; }
   ...
   */
  public StencilOperation getStencilOpFailBack() { return _stencilOpFailBack; }
   ...
   */
  public StencilOperation getStencilOpZFailBack() { return _stencilOpZFailBack; }
   ...
   */
  public StencilOperation getStencilOpZPassBack() { return _stencilOpZPassBack; }

  public boolean isUseTwoSided() { return _useTwoSided; }

  public void setUseTwoSided(final boolean useTwoSided) { _useTwoSided = useTwoSided; }
