...
/**
 * <code>ZBufferState</code> maintains how the use of the depth buffer is to occur. Depth buffer
 * comparisons are used to evaluate what incoming fragment will be used. This buffer is based on z
 * depth, or distance between the pixel source and the eye.
 */
public class ZBufferState extends RenderState {
  ...
  /**
   * Constructor instantiates a new <code>ZBufferState</code> object. The initial values are
   * TestFunction.LessThan and depth writing on.
   */
  public ZBufferState() {}
   ...
   */
  public TestFunction getFunction() { return _function; }
  ...
  @Override
  public StateType getType() { return StateType.ZBuffer; }
