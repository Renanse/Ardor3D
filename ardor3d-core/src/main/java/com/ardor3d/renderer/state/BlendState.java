...
/**
 * <code>BlendState</code> maintains the state of the blending values of a particular node and its
 * children. The blend state provides a method for blending a source pixel with a destination pixel.
 * The blend value provides a transparent or translucent surfaces. For example, this would allow for
 * the rendering of green glass. Where you could see all objects behind this green glass but they
 * would be tinted green.
 */
public class BlendState extends RenderState {
  ...
  public enum SourceFunction {
    ...
    /**
     * The source value of the blend function is the value of the constant color. (Rc, Gc, Bc, Ac) If
     * not set, black with alpha = 0 is used. If not supported, falls back to One.
     */
    ConstantColor(true),
    /**
     * The source value of the blend function is 1 minus the value of the constant color. (1-Rc, 1-Gc,
     * 1-Bc, 1-Ac) If color is not set, black with alpha = 0 is used. If not supported, falls back to
     * One.
     */
    OneMinusConstantColor(true),
    /**
     * The source value of the blend function is the value of the constant color's alpha. (Ac, Ac, Ac,
     * Ac) If not set, black with alpha = 0 is used. If not supported, falls back to One.
     */
    ConstantAlpha(true),
    /**
     * The source value of the blend function is 1 minus the value of the constant color's alpha. (1-Ac,
     * 1-Ac, 1-Ac, 1-Ac) If color is not set, black with alpha = 0 is used. If not supported, falls back
     * to One.
     */
  ...
  public enum DestinationFunction {
    ...
    OneMinusDestinationAlpha(false),
    /**
     * The destination value of the blend function is the value of the constant color. (Rc, Gc, Bc, Ac)
     * If not set, black with alpha = 0 is used. If not supported, falls back to One.
     */
    ConstantColor(true),
    /**
     * The destination value of the blend function is 1 minus the value of the constant color. (1-Rc,
     * 1-Gc, 1-Bc, 1-Ac) If color is not set, black with alpha = 0 is used. If not supported, falls back
     * to One.
     */
    OneMinusConstantColor(true),
    /**
     * The destination value of the blend function is the value of the constant color's alpha. (Ac, Ac,
     * Ac, Ac) If not set, black with alpha = 0 is used. If not supported, falls back to One.
     */
    ConstantAlpha(true),
    /**
     * The destination value of the blend function is 1 minus the value of the constant color's alpha.
     * (1-Ac, 1-Ac, 1-Ac, 1-Ac) If color is not set, black with alpha = 0 is used. If not supported,
     * falls back to One.
     */
    OneMinusConstantAlpha(true);
  ...
  public enum BlendEquation {
    /**
     * Sets the blend equation so that the source and destination data are added. (Default) Clamps to
     * [0,1] Useful for things like antialiasing and transparency.
     */
    Add,
    /**
     * Sets the blend equation so that the source and destination data are subtracted (Src - Dest).
     * Clamps to [0,1] Falls back to Add if supportsSubtract is false.
     */
    Subtract,
    /**
    ...
    ReverseSubtract,
    /**
     * sets the blend equation so that each component of the result color is the minimum of the
     * corresponding components of the source and destination colors. This and Max are useful for
     * applications that analyze image data (image thresholding against a constant color, for example).
     * Falls back to Add if supportsMinMax is false.
     */
    Min,
    /**
     * sets the blend equation so that each component of the result color is the maximum of the
     * corresponding components of the source and destination colors. This and Min are useful for
     * applications that analyze image data (image thresholding against a constant color, for example).
     * Falls back to Add if supportsMinMax is false.
     */
    Max;
  ...
  @Override
  public StateType getType() { return StateType.Blend; }
   ...
   */
  public boolean isBlendEnabled() { return _blendEnabled; }
  ...
  /**
   * <code>setSrcFunction</code> sets the source function for the blending equation for both rgb and
   * alpha values.
   *
   * @param function
  ...
  /**
   * <code>setSrcFunction</code> sets the source function for the blending equation. If
  ...
  /**
   * <code>setSourceFunctionAlpha</code> sets the source function for the blending equation used with
   * alpha values.
   *
   * @param function
   ...
   */
  public SourceFunction getSourceFunctionRGB() { return _sourceFunctionRGB; }
   ...
   * @return the source function for the blending function.
   */
  public SourceFunction getSourceFunctionAlpha() { return _sourceFunctionAlpha; }

  /**
   * <code>setDestinationFunction</code> sets the destination function for the blending equation for
   * both Alpha and RGB values.
   *
   * @param function
  ...
  /**
   * <code>setDestinationFunctionRGB</code> sets the destination function for the blending equation.
   * If supportsSeparateFunc is false, this value will be used for RGB and Alpha.
   *
   * @param function
   ...
   */
  public DestinationFunction getDestinationFunctionRGB() { return _destinationFunctionRGB; }
   ...
   * @return the destination function for the blending function.
   */
  public DestinationFunction getDestinationFunctionAlpha() { return _destinationFunctionAlpha; }
  ...
  public BlendEquation getBlendEquationAlpha() { return _blendEquationAlpha; }

  /**
   * @return the color used in constant blending functions. (0,0,0,0) is the default.
   */
  public ReadOnlyColorRGBA getConstantColor() { return _constantColor; }
  ...
  public void read(final InputCapsule capsule) throws IOException {
    ...
    _sourceFunctionAlpha = capsule.readEnum("sourceFunctionAlpha", SourceFunction.class, SourceFunction.SourceAlpha);
