 ...
 * http://local.wasp.uwa.edu.au/~pbourke/miscellaneous/stereorender/ for a useful discussion on
 * stereo viewing in OpenGL.
 */
public class StereoCamera extends Camera {
   ...
   */
  public boolean isSideBySideMode() { return _sideBySideMode; }

  /**
   * @param sideBySideMode
   *          If true, left camera will be set up to the left half of the render context and right
   *          camera to the right half. If false, the views are set up to be the full size of the
   *          render context.
   */
   ...
   */
  public Camera getLeftCamera() { return _leftCamera; }

  /**
   * @return the rightCamera
   */
  public Camera getRightCamera() { return _rightCamera; }
   ...
   */
  public void setFocalDistance(final double focalDistance) { _focalDistance = focalDistance; }

  /**
   * @return the eyeSeparation
   */
  public double getEyeSeparation() { return _eyeSeparation; }

  /**
   * @param eyeSeparation
   *          the eyeSeparation to set
   */
  public void setEyeSeparation(final double eyeSeparation) { _eyeSeparation = eyeSeparation; }
   ...
   */
  public void setAperture(final double radians) { _aperture = radians; }
}
