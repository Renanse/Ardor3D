...
public class EffectManager {
  ...
  protected void setupDefaultTargets(final TextureStoreFormat outputformat) {
    ...
    _inOutTargetA = new RenderTarget_Texture2D(_canvasSettings.getWidth(), _canvasSettings.getHeight(), outputformat);
    _inOutTargetB = new RenderTarget_Texture2D(_canvasSettings.getWidth(), _canvasSettings.getHeight(), outputformat);
  }
  ...
  public DisplaySettings getCanvasSettings() { return _canvasSettings; }

  public List<RenderEffect> getEffects() { return _effects; }

  public Map<String, RenderTarget> getRenderTargetMap() { return _renderTargetMap; }

  public Renderer getCurrentRenderer() { return _currentRenderer; }

  public RenderTarget getCurrentRenderTarget() { return _currentRenderTarget; }

  public void setCurrentRenderTarget(final RenderTarget target) { _currentRenderTarget = target; }
  ...
  public TextureStoreFormat getOutputFormat() { return _outputFormat; }

  public Camera getSceneCamera() { return _sceneCamera; }

  public void setSceneCamera(final Camera sceneCamera) { _sceneCamera = sceneCamera; }
}
