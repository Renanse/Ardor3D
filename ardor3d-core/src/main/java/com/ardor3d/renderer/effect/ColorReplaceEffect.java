...
public class ColorReplaceEffect extends RenderEffect {
  ...
  public float getRedWeight() { return _redWeight; }

  public void setRedWeight(final float redWeight) { _redWeight = redWeight; }

  public float getGreenWeight() { return _greenWeight; }

  public void setGreenWeight(final float greenWeight) { _greenWeight = greenWeight; }

  public float getBlueWeight() { return _blueWeight; }

  public void setBlueWeight(final float blueWeight) { _blueWeight = blueWeight; }

  public Texture getColorRampTexture() { return _colorRampTexture; }

  public void setColorRampTexture(final Texture colorRampTexture) { _colorRampTexture = colorRampTexture; }
}
