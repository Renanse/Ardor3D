...
public enum TextureCombineMode {
  ...
  /**
   * Combine textures starting from the root node and working towards the given Spatial. Ignore
   * disabled states.
   */
  CombineFirst,

  /**
   * Combine textures starting from the given Spatial and working towards the root. Ignore disabled
   * states. (Default)
   */
  CombineClosest,
