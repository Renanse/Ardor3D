...
public class QuadImposterNode extends Node {
  ...
  public void setRedrawRate(final double rate) { _redrawRate = _elapsed = rate; }

  public double getCameraDistanceThreshold() { return _cameraDistanceThreshold; }
  ...
  public double getCameraAngleThreshold() { return _cameraAngleThreshold; }
  ...
  public Vector3 getWorldUpVector() { return _worldUpVector; }

  public void setWorldUpVector(final Vector3 worldUpVector) { _worldUpVector = worldUpVector; }
  ...
  public void setDoUpdate(final boolean doUpdate) { _doUpdate = doUpdate; }

  public boolean isDoUpdate() { return _doUpdate; }
}
