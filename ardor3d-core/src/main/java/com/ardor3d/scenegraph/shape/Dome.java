...
public class Dome extends Mesh {
  ...
  /**
   * Constructs a dome. All geometry data buffers are updated automatically. Both planes and
   * radialSamples increase the quality of the generated dome.
   * 
   * @param name
   *          Name of the dome.
   * @param center
  ...
  /**
   * Changes the information of the dome into the given values. The boolean at the end signals if
   * buffer data should be updated as well. If the dome is to be rendered, then that value should be
   * true.
   * 
   * @param center
  ...
  public int getPlanes() { return _planes; }
