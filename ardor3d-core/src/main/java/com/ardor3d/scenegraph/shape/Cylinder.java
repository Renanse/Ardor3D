...
/**
 * <code>Cylinder</code> provides an extension of <code>Mesh</code>. A <code>Cylinder</code> is
 * defined by a height and radius. The center of the Cylinder is the origin.
 */
public class Cylinder extends Mesh {
  ...
  /**
   * Creates a new Cylinder. By default its center is the origin. Usually, a higher sample number
  ...
  /**
   * Creates a new Cylinder. By default its center is the origin. Usually, a higher sample number
   * creates a better looking cylinder, but at the cost of more vertex information. <br>
   * If the cylinder is closed the texture is split into axisSamples parts: top most and bottom most
   * part is used for top and bottom of the cylinder, rest of the texture for the cylinder wall. The
   * middle of the top is mapped to texture coordinates (0.5, 1), bottom to (0.5, 0). Thus you need a
   * suited distorted texture.
   * 
   * @param name
   *          The name of this Cylinder.
   * @param axisSamples
  ...
  /**
   * Set the bottom radius of the 'cylinder' to differ from the top radius. This makes the Mesh be a
   * frustum of pyramid, or if set to 0, a cone.
   * 
   * @param radius
   ...
   */
  public int getAxisSamples() { return _axisSamples; }
   ...
   */
  public boolean isInverted() { return _inverted; }
