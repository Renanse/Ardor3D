...
/**
 * <code>Pyramid</code> provides an extension of <code>Mesh</code>. A pyramid is defined by a width
 * at the base and a height. The pyramid is a four sided pyramid with the center at (0,0). The
 * pyramid will be axis aligned with the peak being on the positive y axis and the base being in the
 * x-z plane.
 */
public class Pyramid extends Mesh {
  ...
  /**
   * <code>setVertexData</code> sets the vertices that make the pyramid. Where the center of the box
   * is the origin and the base and height are set during construction.
   */
  ...
  /**
   * <code>setTextureData</code> sets the texture that defines the look of the pyramid. The top point
   * of the pyramid is the top center of the texture, with the remaining texture wrapping around it.
   */
