...
/**
 * Node defines an internal node of a scene graph. The internal node maintains a collection of
 * children and handles merging said children into a single bound to allow for very fast culling of
 * multiple nodes. Node allows for any number of children to be attached.
 */
public class Node extends Spatial {
  ...
  /**
   *
   * <code>attachChild</code> attaches a child to this node. This node becomes the child's parent. The
  ...
  /**
   *
   * <code>attachChildAt</code> attaches a child to this node at an index. This node becomes the
  ...
  /**
   * <code>detachChild</code> removes a given child from the node's list. This child will no longe be
   * maintained.
   *
   * @param child
   *          the child to remove.
  ...
  /**
   * <code>detachChild</code> removes a given child from the node's list. This child will no longe be
   * maintained. Only the first child with a matching name is removed.
   *
   * @param childName
   *          the child to remove.
   * @return the index the child was at. -1 if the child was not in the list.
  ...
  /**
   *
   * <code>detachChildAt</code> removes a child at a given index. That child is returned for saving
   * purposes.
   *
   * @param index
   ...
   */
  public List<Spatial> getChildren() { return _children; }
   ...
   * If our children are Nodes, we will search their children as well.
   *
   * @param name
  ...
  /**
   * <code>updateWorldBound</code> merges the bounds of all the children maintained by this node. This
   * will allow for faster culling operations.
   *
  ...
  @Override
  public Class<? extends Node> getClassTag() { return this.getClass(); }
