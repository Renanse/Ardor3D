...
public class PbrSurface implements IUniformSupplier, Savable {
  ...
  public PbrSurface() {
    ...
    cachedUniforms.add(
        new UniformRef("metallic", UniformType.Float1, UniformSource.Supplier, (Supplier<Float>) this::getMetallic));
    cachedUniforms.add(
        new UniformRef("roughness", UniformType.Float1, UniformSource.Supplier, (Supplier<Float>) this::getRoughness));
    cachedUniforms.add(
        new UniformRef("ao", UniformType.Float1, UniformSource.Supplier, (Supplier<Float>) this::getAmbientOcclusion));
  }
  ...
  public ReadOnlyColorRGBA getAlbedo() { return _albedo; }

  public void setMetallic(final float metallic) { _metallic = metallic; }

  public float getMetallic() { return _metallic; }

  public void setRoughness(final float roughness) { _roughness = roughness; }

  public float getRoughness() { return _roughness; }

  public void setAmbientOcclusion(final float ambientOcclusion) { _ambientOcclusion = ambientOcclusion; }

  public float getAmbientOcclusion() { return _ambientOcclusion; }
   ...
   */
  @Override
  public Class<? extends PbrSurface> getClassTag() { return this.getClass(); }
