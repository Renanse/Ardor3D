...
public class PbrTexturedSurface implements IUniformSupplier, Savable {
  ...
  public PbrTexturedSurface() {
    cachedUniforms.add(
        new UniformRef("albedoMap", UniformType.Int1, UniformSource.Supplier, (Supplier<Integer>) this::getAlbedoMap));
    cachedUniforms.add(
        new UniformRef("normalMap", UniformType.Int1, UniformSource.Supplier, (Supplier<Integer>) this::getNormalMap));
    ...
    cachedUniforms
        .add(new UniformRef("aoMap", UniformType.Int1, UniformSource.Supplier, (Supplier<Integer>) this::getAoMap));
  }

  @Override
  public void applyDefaultUniformValues() {}

  public void setAlbedoMap(final int albedoMap) { _albedoMap = albedoMap; }

  public int getAlbedoMap() { return _albedoMap; }

  public void setNormalMap(final int normalMap) { _normalMap = normalMap; }

  public int getNormalMap() { return _normalMap; }

  public void setMetallicMap(final int metallicMap) { _metallicMap = metallicMap; }

  public int getMetallicMap() { return _metallicMap; }

  public void setRoughnessMap(final int roughnessMap) { _roughnessMap = roughnessMap; }

  public int getRoughnessMap() { return _roughnessMap; }

  public void setAoMap(final int aoMap) { _aoMap = aoMap; }

  public int getAoMap() { return _aoMap; }
   ...
   */
  @Override
  public Class<? extends PbrTexturedSurface> getClassTag() { return this.getClass(); }
