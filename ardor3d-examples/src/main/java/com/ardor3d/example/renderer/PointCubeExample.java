 ...
 */
@Purpose(
    htmlDescriptionKey = "com.ardor3d.example.renderer.PointCubeExample", //
...
public class PointCubeExample extends ExampleBase {
  ...
  public void registerInputTriggers() {
    ...
    _logicalLayer.registerTrigger(new InputTrigger(new KeyPressedCondition(Key.ONE),
        (canvas, inputState, tpf) -> _rotationEnabled = !_rotationEnabled));
    _logicalLayer.registerTrigger(
        new InputTrigger(new KeyPressedCondition(Key.TWO), (canvas, inputState, tpf) -> _waveEnabled = !_waveEnabled));
    _logicalLayer.registerTrigger(new InputTrigger(new KeyPressedCondition(Key.THREE),
        (canvas, inputState, tpf) -> _blurEnabled = !_blurEnabled));
    _logicalLayer.registerTrigger(new InputTrigger(new KeyPressedCondition(Key.FOUR),
        (canvas, inputState, tpf) -> _scaleEnabled = !_scaleEnabled));
  }
