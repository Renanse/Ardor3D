 ...
 */
@Purpose(
    htmlDescriptionKey = "com.ardor3d.example.renderer.CombinerExample", //
...
public class CombinerExample extends ExampleBase {
  ...
  protected void initExample() {
    ...
    _logicalLayer.registerTrigger(new InputTrigger(new KeyPressedCondition(Key.M), (source, inputState, tpf) -> {
    ...
    // Set root to always show, so our text attached to it doesn't disappear when the scene is out of
    // view.
