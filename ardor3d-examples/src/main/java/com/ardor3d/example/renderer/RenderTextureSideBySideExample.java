...
/**
 * Illustrates the TextureRenderer class; which renders a scene to a buffer and copying it to a
 * texture.
 */
@Purpose(
    htmlDescriptionKey = "com.ardor3d.example.renderer.RenderTextureSideBySideExample", //
