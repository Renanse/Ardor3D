 ...
 */
@Purpose(
    htmlDescriptionKey = "com.ardor3d.example.renderer.WireframeGeometryShaderExample", //
...
public class WireframeGeometryShaderExample extends ExampleBase {
  ...
  protected void updateExample(final ReadOnlyTimer timer) {
    rotation.fromAngles(0.2 * timer.getTimeInSeconds(), 0.5 * timer.getTimeInSeconds(), 0.8 * timer.getTimeInSeconds());
