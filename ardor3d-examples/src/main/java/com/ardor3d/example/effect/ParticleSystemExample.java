...
/**
 * A demonstration of the ParticleSystem and TextureState classes; which controls an emitter's
 * properties (e.g. size, color) change over time.
 */
@Purpose(
    htmlDescriptionKey = "com.ardor3d.example.effect.ParticleSystemExample", //
