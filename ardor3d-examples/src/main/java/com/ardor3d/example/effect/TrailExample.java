 ...
 */
@Purpose(
    htmlDescriptionKey = "com.ardor3d.example.effect.TrailExample", //
...
public class TrailExample extends ExampleBase {
  ...
  protected void initExample() {
    ...
    _logicalLayer.registerTrigger(new InputTrigger(new KeyPressedCondition(Key.E), (source, inputStates, tpf) -> {
