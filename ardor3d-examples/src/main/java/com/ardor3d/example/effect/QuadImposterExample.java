 ...
 */
@Purpose(
    htmlDescriptionKey = "com.ardor3d.example.effect.QuadImposterExample", //
...
public class QuadImposterExample extends ExampleBase {
  ...
  protected void initExample() {
    ...
    final QuadImposterNode imposter0 =
        new QuadImposterNode("Imposter1", 512, 512, _settings.getDepthBits(), _settings.getSamples(), _timer);
    ...
    final QuadImposterNode imposter1 =
        new QuadImposterNode("Imposter1", 256, 256, _settings.getDepthBits(), _settings.getSamples(), _timer);
    ...
    final QuadImposterNode imposter2 =
        new QuadImposterNode("Imposter2", 128, 128, _settings.getDepthBits(), _settings.getSamples(), _timer);
