 ...
 */
@Purpose(
    htmlDescriptionKey = "com.ardor3d.example.pbr.SimpleTexturedPbrExample", //
...
public class SimpleTexturedPbrExample extends ExampleBase {
  ...
  protected void initExample() {
    ...
    ts.setTexture(
        TextureManager.load("images/pbr/rustediron1-alt2/albedo.png", Texture.MinificationFilter.Trilinear, true), 0);
    ts.setTexture(
        TextureManager.load("images/pbr/rustediron1-alt2/normal.png", Texture.MinificationFilter.Trilinear, true), 1);
    ts.setTexture(
        TextureManager.load("images/pbr/rustediron1-alt2/metallic.png", Texture.MinificationFilter.Trilinear, true), 2);
    ts.setTexture(
