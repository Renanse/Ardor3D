 ...
 */
@Purpose(htmlDescriptionKey = "com.ardor3d.example.pbr.FullPbrExample", //
    ...
    private void addTeapots() {
...

        {
            ...
            ts.setTexture(TextureManager.load("images/pbr/white-spruce-tree-bark/roughness.png",
                    Texture.MinificationFilter.Trilinear, true), 6);
            ts.setTexture(TextureManager.load("images/pbr/white-spruce-tree-bark/ao.png",
                    Texture.MinificationFilter.Trilinear, true), 7);
            teapot.setRenderState(ts);
            _root.attachChild(teapot);
        }

        {
            ...
            final TextureState ts = new TextureState();
            ts.setTexture(
                    TextureManager.load("images/pbr/metalgrid4/albedo.png", Texture.MinificationFilter.Trilinear, true),
                    3);
            ts.setTexture(
                    TextureManager.load("images/pbr/metalgrid4/normal.png", Texture.MinificationFilter.Trilinear, true),
                    4);
            ts.setTexture(TextureManager.load("images/pbr/metalgrid4/metallic.png",
                    Texture.MinificationFilter.Trilinear, true), 5);
            ts.setTexture(TextureManager.load("images/pbr/metalgrid4/roughness.png",
                    Texture.MinificationFilter.Trilinear, true), 6);
            ts.setTexture(
                    TextureManager.load("images/pbr/metalgrid4/ao.png", Texture.MinificationFilter.Trilinear, true), 7);
            teapot.setRenderState(ts);
            _root.attachChild(teapot);
        }

        {
            ...
            ts.setTexture(TextureManager.load("images/pbr/bamboo-wood-semigloss/roughness.png",
                    Texture.MinificationFilter.Trilinear, true), 6);
            ts.setTexture(TextureManager.load("images/pbr/bamboo-wood-semigloss/ao.png",
                    Texture.MinificationFilter.Trilinear, true), 7);
            teapot.setRenderState(ts);
            _root.attachChild(teapot);
        }

        {
            ...
            final TextureState ts = new TextureState();
            ts.setTexture(TextureManager.load("images/pbr/pockedconcrete1/albedo.png",
                    Texture.MinificationFilter.Trilinear, true), 3);
            ts.setTexture(TextureManager.load("images/pbr/pockedconcrete1/normal.png",
                    Texture.MinificationFilter.Trilinear, true), 4);
            ts.setTexture(TextureManager.load("images/pbr/pockedconcrete1/metallic.png",
                    Texture.MinificationFilter.Trilinear, true), 5);
            ts.setTexture(TextureManager.load("images/pbr/pockedconcrete1/roughness.png",
                    Texture.MinificationFilter.Trilinear, true), 6);
            ts.setTexture(TextureManager.load("images/pbr/pockedconcrete1/ao.png", Texture.MinificationFilter.Trilinear,
                    true), 7);
            teapot.setRenderState(ts);
            _root.attachChild(teapot);
        }
