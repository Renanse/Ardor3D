...
/**
 * Port of a PBR example showing using an hdr skybox to provide diffuse irradiance lighting,
 * originally from https://learnopengl.com/PBR/IBL/Diffuse-irradiance
 */
@Purpose(
    htmlDescriptionKey = "com.ardor3d.example.pbr.SimplePbrDiffuseIrradianceExample", //
