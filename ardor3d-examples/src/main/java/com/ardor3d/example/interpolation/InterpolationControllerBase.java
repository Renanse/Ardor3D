...
public abstract class InterpolationControllerBase<C extends InterpolationController<?, ?>> extends ExampleBase {
  ...
  protected void initExample() {
    ...
    _logicalLayer
        .registerTrigger(new InputTrigger(new KeyPressedCondition(Key.LEFT_BRACKET), (source, inputState, tpf) -> {
    ...
    _logicalLayer
        .registerTrigger(new InputTrigger(new KeyPressedCondition(Key.RIGHT_BRACKET), (source, inputState, tpf) -> {
   ...
   *
   * @return The controller to test, can not be null (otherwise a null pointer exception will be
   *         thrown).
   */
