...
/**
 * A demonstration of the CurveInterpolationController class; which will move/translate a Node each
 * epoch through a set of 3D coordinates (via spline).
 */
@Purpose(
    htmlDescriptionKey = "com.ardor3d.example.interpolation.CurveInterpolationControllerExample", //
