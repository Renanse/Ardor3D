...
public @interface Purpose {
  ...
  /**
   * @return The base filename of the localisation properties file to read
   *         {@link #htmlDescriptionKey() html descriptions} from.
   */
  String localisationBaseFile() default "com/ardor3d/example/i18n/example_descriptions";

  /**
   * @return The key of the description to load from the {@link #localisationBaseFile() localisation
   *         properties file}.
   */
  String htmlDescriptionKey() default "com.ardor3d.example.NotSet";

  /**
   * @return the resource path to a screenshot thumbnail, e.g.
   *         /com/ardor3d/example/thumbnails/boxexample.png
   */
