 ...
 */
@Purpose(
    htmlDescriptionKey = "com.ardor3d.example.pipeline.SimpleObjExample", //
...
public class SimpleObjExample extends ExampleBase {
  ...
  protected void initExample() {
    ...
    try {
      importer.setTextureLocator(new SimpleResourceLocator(
          ResourceLocatorTool.getClassPathResource(SimpleObjExample.class, "com/ardor3d/example/media/models/obj/")));
