 ...
 */
@Purpose(
    htmlDescriptionKey = "com.ardor3d.example.pipeline.SimpleMd2Example", //
  ...
  protected void initExample() {
    ...
    try {
      importer.setTextureLocator(new MultiFormatResourceLocator(
          ResourceLocatorTool.getClassPathResource(SimpleObjExample.class, "com/ardor3d/example/media/models/md2/"),
          ".dds", ".jpg", ".png", ".tga", ".pcx"));
