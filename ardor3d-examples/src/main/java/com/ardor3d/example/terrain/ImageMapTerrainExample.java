...
public class ImageMapTerrainExample extends ExampleBase {
  ...
  protected void initExample() {
    ...
    try {
      ...
      final BufferedImage dudvImage = ImageIO.read(ResourceLocatorTool
          .getClassPathResource(ImageMapTerrainExample.class, "com/ardor3d/example/media/images/water/dudvmap.png"));
      ...
      final TerrainDataProvider terrainDataProvider =
          new ArrayTerrainDataProvider(heightMap, SIZE, new Vector3(3, 50, 3));
