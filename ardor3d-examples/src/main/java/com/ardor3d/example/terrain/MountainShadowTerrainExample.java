...
public class MountainShadowTerrainExample extends ExampleBase {
  ...
  protected void initExample() {
    ...
    canvasCamera.lookAt(
        new Vector3(canvasCamera.getLocation()).addLocal(-0.87105768019686, -0.4349655341112313, 0.22817427967541867),
        Vector3.UNIT_Y);
    ...
    try {
      ...
      final TerrainBuilder builder = new TerrainBuilder(terrainDataProvider, terrainCamera).withShowDebugPanels(true);
