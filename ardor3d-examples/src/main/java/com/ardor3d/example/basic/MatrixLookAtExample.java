...
/**
 * A demonstration of the MathUtils.matrixLookAt function, which constructs a rotation matrix used
 * to orient a source position to a given target position.
 */
@Purpose(
    htmlDescriptionKey = "com.ardor3d.example.basic.MatrixLookAtExample", //
