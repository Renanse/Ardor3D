 ...
 */
@Purpose(
    htmlDescriptionKey = "com.ardor3d.example.basic.DirectionalLightExample", //
    thumbnailPath = "com/ardor3d/example/media/thumbnails/basic_DirectionalLightExample.jpg", //
    maxHeapMemory = 64)
