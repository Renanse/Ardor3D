 ...
 */
@Purpose(
    htmlDescriptionKey = "com.ardor3d.example.benchmark.ball.BubbleMarkUIExample", //
...
public class BubbleMarkUIExample extends ExampleBase {
  ...
  private void buildConfigFrame(final int width, final int height) {
    ...
    vsync.addActionListener(
        event -> GameTaskQueueManager.getManager(_canvas.getCanvasRenderer().getRenderContext()).render(() -> {
    ...
    collide.addActionListener(event -> skipBallCollide = !collide.isSelected());
    panel.add(collide);
    ...
    balls16.addActionListener(event -> resetBalls(16));
    ...
    balls32.addActionListener(event -> resetBalls(32));
    ...
    balls64.addActionListener(event -> resetBalls(64));
    ...
    balls128.addActionListener(event -> resetBalls(128));
