...
public class RotateWidget extends AbstractInteractWidget {
  ...
  protected ReadOnlyQuaternion getNewAxisRotation(final InteractRing ring, final Vector2 oldMouse,
    ...
    if (_interactMatrix == InteractMatrix.World) {
      _rotateStore
          .multiplyLocal(new Quaternion().fromVectorToVector(_calcVec3A, _calcVec3B).toRotationMatrix(_calcMat3));
    }
  ...
  public InteractRing getXRing() { return _xRing; }

  public InteractRing getYRing() { return _yRing; }

  public InteractRing getZRing() { return _zRing; }
}
