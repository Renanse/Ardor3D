...
/**
 * <code>InteractArrow</code> is basically a cylinder with a pyramid on top. It extends the basic
 * Arrow shape to include a customizable gap between arrow head and base, and base and origin. This
 * shape points along the +zaxis instead.
 */
public class InteractArrow extends Arrow {
  ...
  public double getLengthGap() { return _lengthGap; }

  public void setLengthGap(final double lengthGap) { _lengthGap = lengthGap; }

  public double getTipGap() { return _tipGap; }

  public void setTipGap(final double tipGap) { _tipGap = tipGap; }
