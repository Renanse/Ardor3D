...
public class PrimitiveGroup {
  ...
  public IndexMode getType() { return _type; }

  void setType(final IndexMode type) { _type = type; }

  void setIndices(final int[] indices) { _indices = indices; }

  void setNumIndices(final int numIndices) { _numIndices = numIndices; }
}
