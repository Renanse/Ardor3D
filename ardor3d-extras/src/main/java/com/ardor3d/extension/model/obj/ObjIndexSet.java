...
public class ObjIndexSet {
  ...
  public int getVIndex() { return _vIndex; }

  public int getVtIndex() { return _vtIndex; }

  public void setVnIndex(final int index) { _vnIndex = index; }

  public int getVnIndex() { return _vnIndex; }
