...
/**
 * Wavefront OBJ importer. See <a href="http://local.wasp.uwa.edu.au/~pbourke/dataformats/obj/">the
 * format spec</a>
 */
public class ObjImporter {
  ...
  public float getObjSpecularMax() { return _specularMax; }

  public void setObjSpecularMax(final float max) { _specularMax = max; }
    ...
    try {
      ...
      while ((line = reader.readLine()) != null) {
        ...
        // if curve/surface type
          ...
          ObjImporter.logger.warning("ObjModelImporter: cstype not supported.  (line " + lineNo + ") " + line);
        }
   ...
   * @param modelSource
   *          a source to pull the mtl relatively. Used only if a material locator was not set on this
   *          importer.
   * @param store
