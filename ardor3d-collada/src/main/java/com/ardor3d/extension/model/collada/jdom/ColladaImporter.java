...
public class ColladaImporter {
  ...
  public boolean isLoadTextures() { return _loadTextures; }
  ...
  public boolean isCompressTextures() { return _compressTextures; }
  ...
  public boolean isLoadAnimations() { return _loadAnimations; }
  ...
  public boolean isFlipTransparency() { return _flipTransparency; }
   ...
   *          if true, invert the value of any "transparency" entries found - required for some
   *          exporters.
  ...
  public ResourceLocator getTextureLocator() { return _textureLocator; }
  ...
  public Map<String, Joint> getExternalJoints() { return _externalJointMapping; }

  public ResourceLocator getModelLocator() { return _modelLocator; }
  ...
  public boolean isOptimizeMeshes() { return _optimizeMeshes; }
   ...
   *
   * @param resource
   *          the name of the resource to find. ResourceLocatorTool will be used with TYPE_MODEL to
   *          find the resource.
  ...
  public ColladaStorage load(final ResourceSource resource) throws IOException {
    ...
    try {
      ...
      // if we don't specify a texture locator, add a temporary texture locator at the location of this
      // model
      // resource..
  ...
  /**
   * Reads the whole Collada DOM tree from the given resource and returns its root element. Exceptions
   * may be thrown by underlying tools; these will be wrapped in a RuntimeException and rethrown.
   *
   * @param resource
  ...
  /**
   * A JDOMFactory that normalizes all text (strips extra whitespace etc), preparses all arrays and
   * hashes all elements based on their id/sid.
   */
  ...
  /**
   * Parse a numeric value. Commas are replaced by dot automaticly. Also handle special values : INF,
   * -INF, NaN
   *
   * @param number
   *          string
