...
public class AssetData implements Savable {
  ...
  public String getAuthoringTool() { return authoringTool; }

  public void setAuthoringTool(final String authoringTool) { this.authoringTool = authoringTool; }
  ...
  public void setCopyright(final String copyright) { this.copyright = copyright; }

  public String getSourceData() { return sourceData; }

  public void setSourceData(final String sourceData) { this.sourceData = sourceData; }
  ...
  public void setRevision(final String revision) { this.revision = revision; }
  ...
  public float getUnitMeter() { return unitMeter; }

  public void setUnitMeter(final float unitMeter) { this.unitMeter = unitMeter; }

  /**
   * @return the up axis as defined in the &lt;asset> tag, or null if not existing.
   */
  public ReadOnlyVector3 getUpAxis() { return upAxis; }

  public void setUpAxis(final ReadOnlyVector3 upAxis) { this.upAxis = upAxis; }
  ...
  @Override
  public Class<? extends AssetData> getClassTag() { return getClass(); }
