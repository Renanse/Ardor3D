...
public class DataCache {
  ...
  public Map<String, Element> getIdCache() { return _idCache; }

  public Map<String, Element> getSidCache() { return _sidCache; }
  ...
  public List<String> getTransformTypes() { return _transformTypes; }

  public Map<Element, float[]> getFloatArrays() { return _floatArrays; }

  public Map<Element, double[]> getDoubleArrays() { return _doubleArrays; }

  public Map<Element, boolean[]> getBooleanArrays() { return _booleanArrays; }

  public Map<Element, int[]> getIntArrays() { return _intArrays; }

  public Map<Element, String[]> getStringArrays() { return _stringArrays; }

  public Multimap<Element, MeshVertPairs> getVertMappings() { return _vertMappings; }

  public Map<Mesh, VertMap> getMeshVertMap() { return _meshVertMap; }

  public Multimap<MeshData, FloatBuffer> getParsedVertexColors() { return _parsedVertexColors; }

  public Map<String, MaterialInfo> getMaterialInfoMap() { return _materialInfoMap; }

  public Map<Mesh, String> getMeshMaterialMap() { return _meshMaterialMap; }

  public Map<Element, Spatial> getElementSpatialMapping() { return _elementSpatialMapping; }

  public Map<Element, Joint> getElementJointMapping() { return _elementJointMapping; }

  public Map<String, Joint> getExternalJointMapping() { return _externalJointMapping; }

  public JointNode getRootJointNode() { return _rootJointNode; }

  public void setRootJointNode(final JointNode rootJointNode) { _rootJointNode = rootJointNode; }

  public Map<Joint, Skeleton> getJointSkeletonMapping() { return _jointSkeletonMapping; }

  public Map<Skeleton, SkeletonPose> getSkeletonPoseMapping() { return _skeletonPoseMapping; }

  public List<ControllerStore> getControllers() { return _controllers; }

  public List<Skeleton> getSkeletons() { return _skeletons; }
  ...
  public Multimap<Joint, AttachmentPoint> getAttachmentPoints() { return _attachmentPoints; }
}
