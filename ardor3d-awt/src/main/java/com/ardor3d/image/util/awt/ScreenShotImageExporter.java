...
public class ScreenShotImageExporter implements ScreenExportable {
   ...
   * @param prepend
   *          a value to prepend onto the generated file name. This must be at least 3 characters
   *          long.
   * @param format
   *          the format to use for saving the image. ImageIO is used for this, so safe values are
   *          likely: "png", "jpg", "gif" and "bmp"
   * @param useAlpha
   *          true for alpha values to be stored in image (as applicable, depending on the given
   *          format)
   */
  ...
  public void export(final ByteBuffer data, final int width, final int height) {
    final BufferedImage img =
        new BufferedImage(width, height, _useAlpha ? BufferedImage.TYPE_INT_ARGB : BufferedImage.TYPE_INT_RGB);
   ...
   */
  public File getLastFile() { return _lastFile; }

  public File getDirectory() { return _directory; }

  public void setDirectory(final File directory) { _directory = directory; }

  public String getPrepend() { return _prepend; }

  public void setPrepend(final String prepend) { _prepend = prepend; }

  public boolean isUseAlpha() { return _useAlpha; }

  public void setUseAlpha(final boolean useAlpha) { _useAlpha = useAlpha; }

  public String getFileFormat() { return _fileFormat; }

  public void setFileFormat(final String format) { _fileFormat = format; }
}
