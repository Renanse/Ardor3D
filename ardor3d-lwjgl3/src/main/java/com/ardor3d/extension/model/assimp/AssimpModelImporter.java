 ...
 * <b>Known issues:</b>
 * <ul>
 * <li>Loading MD2 models will only give you the first keyframe. Use Ardor3D's Md2Importer if you
 * need frame animation.</li>
 * </ul>
 * </p>
 */
public class AssimpModelImporter {
  ...
  public void setLoadTextures(final boolean loadTextures) { _loadTextures = loadTextures; }

  public void setFlipTextureVertically(final boolean flipTextureVertically) {
    _flipTextureVertically = flipTextureVertically;
  }

  public boolean isFlipTextureVertically() { return _flipTextureVertically; }

  public void setUseCompression(final boolean useCompression) { _useCompression = useCompression; }

  public boolean isUseCompression() { return _useCompression; }
  ...
  private Texture loadTexture(final String textureName) {
    if (_textureLocator == null) {
      return TextureManager.load(textureName, getMinificationFilter(),
          isUseCompression() ? TextureStoreFormat.GuessCompressedFormat : TextureStoreFormat.GuessNoCompressedFormat,
  ...
  private String getTexturePath(final AIMaterial aiMaterial, final int texType) {
    ...
    final int result =
        Assimp.aiGetMaterialTexture(aiMaterial, texType, 0, path, (IntBuffer) null, null, null, null, null, null);
