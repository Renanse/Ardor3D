...
{  
    ...
    gl_FragColor = mix(gl_Fog.color, tint * texCol * vec4(1.0-shade*shadowColor.a), fog);  
//    gl_FragColor = mix(gl_Fog.color, tint * texCol * vec4(1.0-shade*shadowColor.a)*shadowColor, fog);  
}
