...
{  
	...
	// And our normal textures...
	vec4 norm = texture3DBilinear(normalMap, vec3(texCoord.x, texCoord.y, u1));
	vec4 norm2 = texture3DBilinear(normalMap, vec3(texCoord2.x, texCoord2.y, u2));
	...
	// calculate our normal vector from our samples.
