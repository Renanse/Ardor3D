...
public class InMemoryTerrainData {
  ...
  public void setMinHeight(final float minHeight) { this.minHeight = minHeight; }

  public float getMaxHeight() { return maxHeight; }

  public void setMaxHeight(final float maxHeight) { this.maxHeight = maxHeight; }

  public float getUpdateDelta() { return updateDelta; }

  public void setUpdateDelta(final float updateDelta) { this.updateDelta = updateDelta; }

  public byte[] getColorData() { return colorData; }

  public float[] getHeightData() { return heightData; }

  public int getSide() { return side; }

  public Set<Tile>[] getUpdatedTerrainTiles() { return updatedTerrainTiles; }

  public Set<Tile>[] getUpdatedTextureTiles() { return updatedTextureTiles; }

  public boolean isRunning() { return running; }

  public ReadOnlyVector3 getScale() { return scale; }

  public int getClipmapLevels() { return clipmapLevels; }
}
