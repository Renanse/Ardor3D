...
public class TextureConfiguration {
  ...
  public TextureConfiguration(final int totalNrClipmapLevels, final Map<Integer, TextureStoreFormat> textureDataTypes,
    final int cacheGridSize, final float textureDensity, final boolean onlyPositiveQuadrant, final boolean useAlpha) {
  ...
  public Map<Integer, TextureStoreFormat> getTextureDataTypes() { return textureDataTypes; }

  public int getCacheGridSize() { return cacheGridSize; }

  public float getTextureDensity() { return textureDensity; }
  ...
  public String toString() {
    return "TextureConfiguration [cacheGridSize=" + cacheGridSize + ", onlyPositiveQuadrant=" + onlyPositiveQuadrant
        + ", textureDataTypes=" + textureDataTypes + ", textureDensity=" + textureDensity + ", totalNrClipmapLevels="
        + totalNrClipmapLevels + ", useAlpha=" + useAlpha + "]";
  }
}
