...
public interface TextureSource {
  ...
  /**
   * Returns which tiles contain data in the requested region. May return null to indicate all tiles
   * are invalid, or that this source does not support determining valid tiles.
   *
   * @param clipmapLevel
   * @param tileX
   * @param tileY
  ...
  /**
   * Returns which tiles should be marked as invalid and updated in the requested region. May return
   * null to indicate no tiles are invalid, or this source does not support invalid tiles.
   *
   * @param clipmapLevel
   * @param tileX
   * @param tileY
