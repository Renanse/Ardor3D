...
public abstract class AbstractAwtElement {
  ...
  public ReadOnlyTransform getTransform() { return _transform; }
  ...
  public Composite getCompositeOverride() { return _compositeOverride; }
  ...
  public void updateBounds() {
    ...
    // So apply transform
    final double x = _awtBounds.getX(), y = _awtBounds.getY(), width = _awtBounds.getZ(), height = _awtBounds.getW();
  ...
  public ReadOnlyVector4 getBounds() { return _awtBounds; }

  public void setUpdateListener(final ElementUpdateListener listener) { _listener = listener; }
  ...
  public Map<RenderingHints.Key, Object> getHints() { return hints; }
}
