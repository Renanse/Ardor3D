...
public class AwtShapeElement extends AbstractAwtElement {
  ...
  public void setFilled(final boolean filled) { _filled = filled; }

  public Color getFillColor() { return _fillColor; }

  public void setFillColor(final Color color) { _fillColor = color; }

  public boolean isOutlined() { return _outlined; }

  public void setOutlined(final boolean outlined) { _outlined = outlined; }

  public Color getOutlineColor() { return _outlineColor; }

  public void setOutlineColor(final Color color) { _outlineColor = color; }
  ...
  public Vector4 getMargin() { return _margin; }
