...
public class AnimationEntryEditDialog extends JDialog {
  ...
  public AnimationEntryEditDialog(final AnimationEntry entry) {
    ...
    offsetPanel.addChangeListener(e -> entry.setOffset(offsetPanel.getIntValue() / 100.0));
    ...
    ratePanel.addChangeListener(e -> entry.setRate(ratePanel.getFloatValue()));
    ...
    rate.add(ratePanel, new GridBagConstraints(0, 0, 1, 1, 1.0, 0.0, GridBagConstraints.CENTER,
        GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
    add(rate, new GridBagConstraints(0, 1, 1, 1, 1.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
        new Insets(10, 5, 5, 5), 0, 0));
    ...
    add(frames, new GridBagConstraints(0, 2, 1, 1, 1.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
        new Insets(10, 5, 5, 5), 0, 0));
