...
public class WindInfluencePanel extends InfluenceEditPanel {
  ...
  public WindInfluencePanel() {
    ...
    _windDirectionPanel.addChangeListener(e -> ((SimpleParticleInfluenceFactory.BasicWind) getEdittedInfluence())
        .setWindDirection(_windDirectionPanel.getValue()));
    ...
    _windRandomBox = new JCheckBox(new AbstractAction("Vary Randomly") {
      ...
      public void actionPerformed(final ActionEvent e) {
        ((SimpleParticleInfluenceFactory.BasicWind) getEdittedInfluence()).setRandom(_windRandomBox.isSelected());
      }
    });
    ...
    add(_windStrengthPanel, new GridBagConstraints(0, 1, 1, 1, 0.5, 0.0, GridBagConstraints.CENTER,
        GridBagConstraints.HORIZONTAL, new Insets(5, 5, 10, 5), 0, 0));
    add(_windRandomBox, new GridBagConstraints(0, 2, 1, 1, 0.5, 0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE,
        new Insets(5, 5, 10, 5), 0, 0));
  }

  @Override
  public void updateWidgets() {
    final SimpleParticleInfluenceFactory.BasicWind wind =
