...
public class ParticleInfluencePanel extends ParticleEditPanel {
  ...
  private final JList<String> _influenceList = new JList<>(_influenceModel);
  ...
  public ParticleInfluencePanel() {
    ...
    final JButton newInfluenceButton = new JButton(new AbstractAction("Add Influence") {
      ...
      private ParticleInfluence getNewInfluence() {
        ...
        if ("wind".equals(chosen)) {
          ...
          infl = SimpleParticleInfluenceFactory.createBasicVortex(1f, 0f, new Line3(new Vector3(), Vector3.UNIT_Y),
              true, true);
    ...
    _influenceList.addListSelectionListener(e -> {
      final int idx = _influenceList.getSelectedIndex();
    ...
    influenceListPanel.add(newInfluenceButton, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
  ...
  public void updateWidgets() {
    ...
    final int fcount =
        (getEdittedParticles().getInfluences() == null) ? 0 : getEdittedParticles().getInfluences().size();
