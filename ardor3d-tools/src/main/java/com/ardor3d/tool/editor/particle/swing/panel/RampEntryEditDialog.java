...
public class RampEntryEditDialog extends JDialog {
  ...
  public RampEntryEditDialog(final RampEntry entry) {
    ...
    if (entry.getOffset() != -1) {
      ...
      offsetPanel.addChangeListener(e -> entry.setOffset(offsetPanel.getIntValue() / 100f));
      ...
      add(off, new GridBagConstraints(1, 0, 1, 1, 1.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
          new Insets(10, 5, 5, 5), 0, 0));
    }

    final ValuePanel sizePanel = new ValuePanel("Size: ", "", 0.0, Double.MAX_VALUE, 1.0);
    sizePanel.setValue(0.0);
    sizePanel.addChangeListener(e -> entry.setSize(sizePanel.getDoubleValue()));

    if (entry.getOffset() != -1) {
      final JCheckBox sizeCheck = new JCheckBox("");
      sizeCheck.addActionListener(e -> {
      ...
      add(sizeCheck, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0, GridBagConstraints.NORTHEAST, GridBagConstraints.NONE,
          new Insets(10, 5, 5, 5), 0, 0));
    }
    if (entry.hasSizeSet()) {
    ...
    size.add(sizePanel, new GridBagConstraints(0, 0, 1, 1, 1.0, 0.0, GridBagConstraints.CENTER,
        GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
    add(size, new GridBagConstraints(1, 1, 1, 1, 1.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
        new Insets(10, 5, 5, 5), 0, 0));

    final ValuePanel spinPanel = new ValuePanel("Spin: ", "", -Double.MAX_VALUE, Double.MAX_VALUE, 0.01);
    spinPanel.setValue(0.0);
    spinPanel.addChangeListener(e -> entry.setSpin(spinPanel.getDoubleValue()));

    if (entry.getOffset() != -1) {
      final JCheckBox spinCheck = new JCheckBox("");
      spinCheck.addActionListener(e -> {
      ...
      add(spinCheck, new GridBagConstraints(0, 2, 1, 1, 0.0, 0.0, GridBagConstraints.NORTHEAST, GridBagConstraints.NONE,
          new Insets(10, 5, 5, 5), 0, 0));
    }
    if (entry.hasSpinSet()) {
    ...
    spin.add(spinPanel, new GridBagConstraints(0, 0, 1, 1, 1.0, 0.0, GridBagConstraints.CENTER,
        GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
    add(spin, new GridBagConstraints(1, 2, 1, 1, 1.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
        new Insets(10, 5, 5, 5), 0, 0));

    final ValuePanel massPanel = new ValuePanel("Mass: ", "", -Double.MAX_VALUE, Double.MAX_VALUE, 0.01);
    massPanel.setValue(0.0);
    massPanel.addChangeListener(e -> entry.setMass(massPanel.getDoubleValue()));

    if (entry.getOffset() != -1) {
      final JCheckBox massCheck = new JCheckBox("");
      massCheck.addActionListener(e -> {
      ...
      add(massCheck, new GridBagConstraints(0, 3, 1, 1, 0.0, 0.0, GridBagConstraints.NORTHEAST, GridBagConstraints.NONE,
          new Insets(10, 5, 5, 5), 0, 0));
    }
    if (entry.hasMassSet()) {
    ...
    mass.add(massPanel, new GridBagConstraints(0, 0, 1, 1, 1.0, 0.0, GridBagConstraints.CENTER,
        GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
    add(mass, new GridBagConstraints(1, 3, 1, 1, 1.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
        new Insets(10, 5, 5, 5), 0, 0));
  ...
  private void initColorChooser(final RampEntry entry) {
    ...
    cancelButton.addActionListener(e -> _colorChooserDialog.setVisible(false));
