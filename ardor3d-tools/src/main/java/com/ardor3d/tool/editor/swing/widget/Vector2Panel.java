...
public class Vector2Panel extends JPanel implements ChangeListener {
    ...
    public Vector2Panel(final double min, final double max, final double step, final boolean vertical) {
        ...
        if (vertical) {
            ...
            add(_xPanel, new GridBagConstraints(0, 0, 1, 1, .5, 0.0, GridBagConstraints.CENTER,
                    GridBagConstraints.HORIZONTAL, new Insets(5, 5, 5, 5), 0, 0));
            add(_yPanel, new GridBagConstraints(1, 0, 1, 1, .5, 0.0, GridBagConstraints.CENTER,
                    GridBagConstraints.HORIZONTAL, new Insets(5, 5, 5, 5), 0, 0));
        }
    }
    ...
    public Vector2 getValue() {
        return new Vector2(_xPanel.getDoubleValue(), _yPanel.getDoubleValue());
    }
