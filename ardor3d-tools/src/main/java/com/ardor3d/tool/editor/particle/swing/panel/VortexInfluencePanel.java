...
public class VortexInfluencePanel extends InfluenceEditPanel {
    ...
    private final JComboBox<String> _vortexTypeBox = new JComboBox<String>(new String[] { "Cylinder", "Torus" });
    private final ValuePanel _vortexRadiusPanel = new ValuePanel("Radius: ", "", 0.0, Double.MAX_VALUE, 1.0);
    private final ValuePanel _vortexHeightPanel = new ValuePanel("Height: ", "", -Double.MAX_VALUE, Double.MAX_VALUE,
            1.0);
    ...
    public VortexInfluencePanel() {
        ...
        _vortexTypeBox.addActionListener(new ActionListener() {
        ...
        _vortexRadiusPanel.addChangeListener(new ChangeListener() {
            public void stateChanged(final ChangeEvent e) {
                ((SimpleParticleInfluenceFactory.BasicVortex) getEdittedInfluence()).setRadius(_vortexRadiusPanel
                        .getDoubleValue());
            }
        });

        _vortexHeightPanel.addChangeListener(new ChangeListener() {
            public void stateChanged(final ChangeEvent e) {
                ((SimpleParticleInfluenceFactory.BasicVortex) getEdittedInfluence()).setHeight(_vortexHeightPanel
                        .getDoubleValue());
            }
        });

        _vortexDirectionPanel.setBorder(createTitledBorder(" DIRECTION "));
        _vortexDirectionPanel.addChangeListener(new ChangeListener() {
            public void stateChanged(final ChangeEvent e) {
                final SimpleParticleInfluenceFactory.BasicVortex vortex = (SimpleParticleInfluenceFactory.BasicVortex) getEdittedInfluence();
                final Line3 axis = new Line3(vortex.getAxis());
                axis.setDirection(_vortexDirectionPanel.getValue());
                vortex.setAxis(axis);
            }
        });
        _vortexStrengthPanel.addChangeListener(new ChangeListener() {
            public void stateChanged(final ChangeEvent e) {
                ((SimpleParticleInfluenceFactory.BasicVortex) getEdittedInfluence()).setStrength(_vortexStrengthPanel
                        .getDoubleValue());
            }
        });
        _vortexDivergencePanel.addChangeListener(new ChangeListener() {
            public void stateChanged(final ChangeEvent e) {
        ...
        _vortexRandomBox = new JCheckBox(new AbstractAction("Vary Randomly") {
            ...
            public void actionPerformed(final ActionEvent e) {
                ((SimpleParticleInfluenceFactory.BasicVortex) getEdittedInfluence()).setRandom(_vortexRandomBox
                        .isSelected());
            }
        });
