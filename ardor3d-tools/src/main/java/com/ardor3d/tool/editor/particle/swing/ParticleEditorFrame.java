...
public class ParticleEditorFrame extends JFrame {
    ...
    private static final String[] EXAMPLE_NAMES = { "Fire", "Fountain", "Lava", "Smoke", "Jet", "Snow", "Rain",
            "Explosion", "Ground Fog", "Fireflies" };
    ...
    private void init() throws Exception {
        ...
        appearancePanel = new ParticleAppearancePanel(prefs) {
            ...
            protected void requestParticleSystemOverwrite(final ParticleSystem newParticles) {
                editScene.particleNode.getChildren()
                        .set(editScene.particleNode.getChildren().indexOf(editScene.particleGeom), newParticles);
    ...
    private JMenuBar createMenuBar() {
        ...
        final Action showGrid = new AbstractAction("Show Grid") {
            ...
            @Override
            public void actionPerformed(final ActionEvent e) {
                editScene.grid.getSceneHints()
                        .setCullHint(editScene.grid.getSceneHints().getCullHint() == CullHint.Always ? CullHint.Dynamic
                                : CullHint.Always);
    ...
    private JPanel createLayerPanel() {
        ...
        layerTable.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(final ListSelectionEvent e) {
                if (layerTable.getSelectedRow() != -1) {
                    editScene.particleGeom = (ParticleSystem) editScene.particleNode
        ...
        layerPanel.add(new JScrollPane(layerTable), new GridBagConstraints(0, 1, 2, 1, 1.0, 1.0,
    ...
    private JPanel createExamplesPanel() {
        ...
        exampleList = new JList<String>(EXAMPLE_NAMES);
    ...
    private void saveAs(File file) {
        ...
        try {
            new BinaryExporter().save(
                    editScene.particleNode.getNumberOfChildren() > 1 ? editScene.particleNode : editScene.particleGeom,
                    file);
            openFile = file;
            updateTitle();
    ...
    protected Lwjgl3AwtCanvas createParticleCanvas() {
            ...
            public void componentResized(final ComponentEvent e) {
                if (canvasRenderer.getCamera() != null) {
                    ...
                    canvasRenderer.getCamera().setFrustumPerspective(45.0,
                            theCanvas.getWidth() / (float) theCanvas.getHeight(), 1, 10000);
                }
            }
        });
        ...
        final RendererCallable<Void> exe = new RendererCallable<Void>() {
            @Override
            public Void call() {
    ...
    class CameraHandler extends MouseAdapter implements MouseMotionListener, MouseWheelListener {
        ...
        private void rotateCamera(final ReadOnlyVector3 axis, double amount) {
            ...
            if (axis.equals(cam.getLeft())) {
                ...
                amount = Math.min(Math.max(elevation + amount, -(MathUtils.DEG_TO_RAD * 89)),
                        (MathUtils.DEG_TO_RAD * 89)) - elevation;
            }
